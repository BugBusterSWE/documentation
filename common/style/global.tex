...
\newcommand{\GroupName}{BugBusters}
\newcommand{\GroupEmail}{bugbusterswe@gmail.com}
\newcommand{\ProjectName}{MaaS}
...
\newcommand{\Responsabile}{Matteo Di Pirro}

% La versione dei documenti deve essere definita qui in global, perchè serve anche agli altri documenti
%TODO Aggiornare a 5.0.0
\newcommand{\VersioneG}{5.0.0}
\newcommand{\VersionePQ}{6.0.0}
\newcommand{\VersioneNP}{6.0.0}
\newcommand{\VersionePP}{6.0.0}
\newcommand{\VersioneAR}{5.0.0}
\newcommand{\VersioneSF}{5.0.0}
...
\newcommand{\ScopoDelProdotto}{
	Lo scopo del progetto è la realizzazione del progetto \glossaryItem{MaaP} \textit{As a Service}.}
...
\newcommand{\makeFrontPage}{
  ...
  \begin{center}
  \includegraphics[width=10cm]{../../common/style/logo.png}
  \end{center}
