...
name = node.js,
description = {Framework per la creazione di applicazioni distribuite. Utilizza JavaScript come linguaggio di scripting e gestisce le attese I/O in modo asincrono.}
}


\newglossaryentry{angularjs}{
name = angular.js,
description = { Framework open-source per lo sviluppo di applicazioni web. Fornisce una piattaforma per l'implementazione del \textit{pattern} MVC (Model-View-Controller) lato \textit{client}.}
}


\newglossaryentry{backend}{
name = back end,
description = { Termine inglese che indica la parte di un sistema \textit{software} che si occupa della memorizzazione e del recupero dei dati.}
}
...
description = { (Acronimo per \textbf{D}omain \textbf{S}pecific \textbf{L}anguage) Linguaggio per computer specializzato per uno specifico dominio di applicazione.}
}

\newglossaryentry{reactjs}{
name = react.js,
description = { React è una libreria Javascript per la creazione di interfacce utente realizzata da Facebook. Tale libreria ha lo scopo di implementare la parte visiva dei dati nel pattern \textit{Model-View-Controller}. I suoi punti di forza sono la semplicità del suo utilizzo e la modularità dei suoi componenti.}
}
...
name = pollution,
description = {Termine che indica l'insieme di tutti i file che non devono entrare nel repository.}
}
...
\newglossaryentry{csv}{
name = csv,
description = { \textbf{C}omma \textbf{S}eparated \textbf{V}alues \`e un formato di file di testo utilizzato nell-esportazione di dati tabellari.}
}


\newglossaryentry{softwareasaservice}{
name = software as a service,
description = { \`E un modello di distribuzione del software applicativo dove un produttore di software sviluppa, opera (direttamente o tramite terze parti) e gestisce un'applicazione web che mette a disposizione dei propri clienti via internet.}
}

\newglossaryentry{task}{
name = task,
description = {Compito assegnato ad un singolo individuo.}
}

\newglossaryentry{terminale}{
name = terminale,
description = {\`E un dispositivo hardware elettronico o elettromeccanico che viene usato per inserire dati in input ad un computer o di un sistema di elaborazione e riceverli in output per la loro visualizzazione.}
}

\newglossaryentry{dslelement}{
name = DSL Element,
description = {Rappresentazione grafica sulla sessione dell'editor dell'applicazione MaaS.}
}

\newglossaryentry{collectionelement}{
name = Collection Element,
description = {Rappresentazione grafica nell'editor di una struttura Collection definita nel DSL.}
}

\newglossaryentry{functionelement}{
name = Function Element,
description = {Rappresentazione grafica nell'editor di una funzione JavaScript.}
}

\newglossaryentry{indexelement}{
name = Index Element,
description = {Rappresentazione grafica nell'editor della struttura Index definita nel DSL.}
}

\newglossaryentry{columnelement}{
name = Column Element,
description = {Rappresentazione grafica nell'editor della struttura Column definita nel DSL.}
}

\newglossaryentry{rowelement}{
name = Row Element,
description = {Rappresentazione grafica nell'editor della struttura Row definita nel DSL.}
}

\newglossaryentry{documentelement}{
name = Document Element,
description = {Rappresentazione grafica nell'editor della struttura Document definita nel DSL.}
}

\newglossaryentry{inputelement}{
name = Input Element,
description = {Rappresentazione grafica nell'editor della struttura Input definita nel DSL.}
}

\newglossaryentry{cellelement}{
name = Cell Element,
description = {Rapprensetazione grafica nell'editor della struttura Cell definita nel DSL.}
}

\newglossaryentry{dashboardelement}{
name = Dashboard Element,
description = {Rappresentazione grafica nell'editor della struttura Dashboard definita nel DSL.}
}

\newglossaryentry{dashrowelement}{
name = DashRow Element,
description = {Rappresentazione grafica nell'editor della struttura DashRow definita nel DSL.}
}

\newglossaryentry{actionelement}{
name = Action Element,
description = {Rappresentazione grafica nell'edito della struttura Action Element definita nel DSL.}
}

\newglossaryentry{deployment}{
name = deployment,
description = {insieme di attività che rende un software pronto per essere utilizzato.}
}

\newglossaryentry{heroku}{
name = heroku,
description = {\textit{platform as a service} su cloud in grado di supportare diversi linguaggi di programmazione.}
}

\newglossaryentry{collection}{
name = Collection,
description = {Elemento singolo del DSL, specifica 5 concetti principali:
\begin{itemize}
\item Identificare la specifica collezzione;
\item Il sotto insieme di documenti che l'utente pu\`o vedere;
\item Il sotto insieme di attributi che l'utente pu\`o vedere quando visualizza la lista dei documenti;
\item Il sotto insieme di attributi che l'utente pu\`o vedere quando visualizza uno specifico documento;
\item Le \textit{Action} applicate all'intera collezzione.
\end{itemize}
}
}
...
name = index,
description = {Attributo della \glossaryItem{Collection}} che specifica come la index-page sar\`a configurata.}
}

\newglossaryentry{column}{
name = column,
description = {Attributo di \glossaryItem{Index} che specifica la configurazione di una colonna della tabella nella index-page.}
}

\newglossaryentry{row}{
name = row,
description = {Attributo di \glossaryItem{Document} che specifica la configurazione di una riga della tabella nella show-page.}
}


\newglossaryentry{cell}{
name = cell,
description = {Elemento singolo del DSL che rappresenta un singolo elemento.}
}

\newglossaryentry{dashrow}{
aname = dashrow,
description = {Attributo della \glossaryItem{Dashboard}, specifica la configurazione di una riga del layout a griglia nella dashboard-page.}
}

\newglossaryentry{action}{
name = action,
description = {Elemento singolo del DSL specifica quale azione, lato server, l'utente pu\`o compiere su una \glossaryItem{Collection} o un \glossaryItem{Document}.}
}
