...
\begin{center}
    ...
    \begin{longtable}{ >{\centering}p{1.8cm} | >{\centering}p{2.2cm} | >{\centering}p{3cm} | >{\centering}p{6cm} }
      ...
      4.0.6 & 2016/05/29 & Matteo Di Pirro \linebreak(Amministratore) & Aggiunta il termine XSL \tabularnewline \hline
      4.0.5 & 2016/05/29 & Matteo Di Pirro \linebreak(Amministratore) & Aggiunta il termine XML Schema \tabularnewline \hline
      4.0.4 & 2016/05/29 & Matteo Di Pirro \linebreak(Amministratore) & Aggiunta il termine tag \tabularnewline \hline
