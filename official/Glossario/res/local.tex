...
\fancypagestyle{plain}{
	...
	\lhead{
		\includegraphics[height=1.5cm, width=1.5cm, keepaspectratio=true]{../../common/style/logo.png}
		\parbox[b]{10cm}{
	...
	\lfoot{
        ...
        %Nel glossario la pagina finale stampa sempre 1, quindi non visualizziamo quante pagine di sono
	\rfoot{Pagina \thepage{}}
...
\newcommand{\DocRedazione}{Andrea Mantovani, Davide Polonio, Matteo Di Pirro, Luca Bianco}
