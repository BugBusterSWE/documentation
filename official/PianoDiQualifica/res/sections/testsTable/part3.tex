...
TS-R1O 36.4 & Verificare che l'Admin possa aggiungere delle \glossaryItem{Collection} in \glossaryItem{fase} di moodifica di un database. & N.E & R1O 36.4 \tabularnewline \hline
...
TS-R1D 36.6 & Verificare che l'Admin deve poter decidere se la \glossaryItem{Collection} è visibile dai member in \glossaryItem{fase} di modifica di un database. & N.E & R1D 36.6 \tabularnewline \hline
...
TS-R1O 36.8 & Verificare che l'Admin deve poter modificare una \glossaryItem{Collection} in \glossaryItem{fase} di modifica di un database. & N.E & R1O 36.8 \tabularnewline \hline
