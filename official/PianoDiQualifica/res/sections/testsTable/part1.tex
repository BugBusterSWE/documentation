...
%TS-R1O 3.2 & Verificare che l'utente autenticato (con ruolo superiore a Member) possa a modificare una DSL specifica (dopo l'accesso all'editor). & N.E & R10 3.2 \tabularnewline \hline %15

%TS-R1O 3.3 & Verificare che l'utente autenticato (con ruolo superiore a Member) possa a creare una DSL specifica (dopo l'accesso all'editor). & N.E & R10 3.3 \tabularnewline \hline %16
...
%TS-R1O 3.5 & Verificare che l'Admin possa aggiungere/togliere i permessi di lettura/scrittura su una DSL specifica ad un utente di una Company. & N.E & R10 3.5 \tabularnewline \hline %18
