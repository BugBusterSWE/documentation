...
\textbf{Di Documentazione (Codice)} & ?? \\ \cline{1-2} % (ore di stesura codice)/(numero righe di documentazione del codice => vedi "logical sloc" nel tool di misura) 
\textbf{Di Codifica} & ?? \\ \cline{1-2} % (ore di stesura del codice)/(numero di righe di codice => vedi misurazione sloc nella sezione di misurazione del codice)
\end{tabular}
