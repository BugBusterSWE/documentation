...
TI-B   & Verificare che il \textit{package} \textbf{Backend} \{MaaSServer} si integri correttamente 
...
TI-BR  & Verificare la corretta integrazione tra i \textbf \textit{package} \textbf{Backend}
