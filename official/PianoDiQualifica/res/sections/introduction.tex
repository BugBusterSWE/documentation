...
Lo scopo primario è la \glossaryItem{qualità} del prodotto e dei suoi \glossaryItem{processi}, ottenibile solo attraverso una serie continua di controlli. Il \glossaryItem{team} si impone una rigida e costante attività di \glossaryItem{verifica}, per poter individuare e correggere eventuali errori presenti nei documenti e nel \glossaryItem{codice sorgente}. L'assenza di tali controlli porterebbe al deterioramento del prodotto, soprattutto se in presenza di un \glossaryItem{team} giovane e con poca esperienza alle spalle. \\
È volontà del \glossaryItem{team} non operare \glossaryItem{by correction} che comporterebbe il \glossaryItem{rischio} di ritardi nella maturazione del prodotto.

\subsection{Scopo del documento}
Il presente documento contiene le strategie di \glossaryItem{verifica} e \glossaryItem{validazione} che il \glossaryItem{team} BugBusters ha deciso di adottare. La ricerca della \glossaryItem{qualità}, nei prodotti e nei \glossaryItem{processi}, non rientra nei ruoli canonici di un \glossaryItem{progetto}, ma è una \glossaryItem{funzione aziendale}; il \glossaryItem{committente}, potrà, attraverso le strategie qui documentate, valutare su basi oggettive il prodotto e disporre di una solida batteria di test.
...
\begin{itemize}
\item \textbf{Piano di \glossaryItem{Progetto}}: \PianoDiProgetto;
...
\item \textbf{Indice \glossaryItem{Gulpease}}: \url{https://it.wikipedia.org/wiki/Indice_Gulpease};
\end{itemize}
