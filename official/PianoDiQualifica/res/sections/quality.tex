...
Il ciclo \glossaryItem{PDCA} è un ciclo iterativo che si compone di 4 passi. Ha come scopo il controllo e il miglioramento continuo dei processi (e dei prodotti risultanti da tali processi). 
\begin{enumerate}
...
\item \textbf{Check}: fase di \glossaryItem{verifica}. Vengono controllati i prodotti e i processi attuati nella fase Do e confrontati con quanto pianificato nella fase Plan. Le informazioni raccolte saranno utili per intervenire in tempo in caso di errori, per avere un controllo sullo stato dei processi e dei prodotti, per migliorare i risultati.
\item \textbf{Act}: Fase di “miglioramento continuo”. Se i risultati prodotti in Do sono diversi rispetto a quelli attesi dalla fase Plan, allora probabilmente è necessario ripetere di nuovo il ciclo \glossaryItem{PDCA} e adottare delle azioni per il miglioramento continuo.
\end{enumerate}
