...
\begin{center}
  ...
  \begin{table}[H]
    ...
    \begin{tabular}{ >{\centering}p{1.8cm} | >{\centering}p{2.2cm} | >{\centering}p{3cm} | >{\centering}p{6cm} }
      ...
      4.0.0 & 2016/04/08 & Giovanni Mazzocchin \linebreak (Responsabile) & Approvazione documento \tabularnewline \hline
      3.1.0 & 2016/04/07 & Davide Polonio \linebreak (Verificatore) & Verifica \tabularnewline \hline
      3.0.1 & 2016/03/22 & Giovanni Mazzocchin \linebreak (Responsabile) & Incremento \tabularnewline \hline
