...
\subsubsection{Conclusione}
Il \glossaryItem{team} ha impegnato tre ore in meno per l'attivit\`a di verifica, un'ora ora in meno per l'attivit\`a di Progettista e tre ore in più per l'attivit\`a di Amministratore. Questo ha permesso di risparmiare un'ora e 7,00 \euro{}, portando il costo consuntivo al di sotto di quello preventivato.
...
\subsubsection{Consuntivo}
Verranno indicate le ore di ruolo e le spese effettivamente sostenute durante la \glossaryItem{fase} di Progettazione Architetturale.
...
\begin{table}[H]
	...
	\begin{tabular}{ l c c }
		...
		\hline
	\end{tabular}
	\caption{Ore non rendicontate, differenza preventivo/consuntivo in \glossaryItem{fase} di Progettazione Architetturale}
\end{table}
