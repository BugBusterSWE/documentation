...
\item \textit{Attuazione nel periodo}: indica se i \glossaryItem{rischi} si sono verificati o meno.
\end{itemize}
...
\item \textit{Attuazione nel periodo}: 
	\begin{itemize}
	\item \textit{Analisi}: questo \glossaryItem{rischio} si è verificato sopprattutto durante le prime riunioni interne, quando si doveva stabilire come distribuire i ruoli ed il lavoro tra i membri del gruppo;
...
\item \textit{Attuazione nel periodo}: 
	\begin{itemize}
	\item \textit{Analisi}: questo \glossaryItem{rischio} non si è verificato a causa della scarsa essperienza del gruppo;
	\item \textit{Analisi Miglioramenti}: questo \glossaryItem{rischio} non si è verificato;
	\item \textit{Progettazione Architetturale}: questo \glossaryItem{rischio} non si è verificato.
	\item \textit{Progettazione di Dettaglio e Codifica}: questo \glossaryItem{rischio} non si è mai verificato.
	\end{itemize}
