...
Di seguito \`e riportato il \glossaryItem{consuntivo} complessivo dei periodi di \textit{Analisi}, \textit{Analisi Miglioramenti}, \textit{Progettazione Architetturale}, \textit{Progettazione di Dettaglio e Codifica} e di \textit{Validazione}. 
