...
Di seguito è riportato il \textit{Bilancio delle Spese Effettive} complessivo dei periodi di \textit{Analisi}, \textit{Analisi Miglioramenti}, \textit{Progettazione Architetturale} e \textit{Progettazione di Dettaglio e Codifica}.
...
Poichè si ricorda che le ore del periodo di \textit{Analisi} sono a carico del fornitore, di seguito è riportato il \textit{Bilancio delle Spese Effettive} complessivo dei soli periodi di \textit{Analisi Miglioramenti}, \textit{Progettazione Architetturale} e \textit{Progettazione di Dettaglio e Codifica}.
