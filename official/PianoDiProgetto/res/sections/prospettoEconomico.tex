...
%-----------------------------------------------------------------------------------------------------
\subsection{Analisi}
A scopo di trasparenza viene redatto il prospetto economico riguardante la \glossaryItem{fase} di Analisi dei Requisiti, che si precisa essere a carico del fornitore, e non del proponente.
...
\begin{table}[H]
	...
	\begin{tabular}{ l c c }
		...
		\hline
	\end{tabular}
	\caption{Ore e costo per ruolo, \glossaryItem{fase} di Analisi}
\end{table}

I seguenti grafici mostrano il peso orario e di costo di ogni ruolo in questa \glossaryItem{fase}.

\begin{figure}[H]
  \begin{center}
    \includegraphics[width=15cm]{res/img/prospettoEconomico/orePerRuoloAnalisi.png}
  \caption{Ore per ruolo, \glossaryItem{fase} di Analisi}
  \end{center} 
\end{figure}  
...
\begin{figure}[H]
  ...
  \caption{Costo per ruolo, \glossaryItem{fase} di Analisi}
  \end{center} 
\end{figure}  
...
A scopo di trasparenza viene redatto il prospetto economico riguardante la \glossaryItem{fase} di Analisi Miglioramenti.
...
Nella \glossaryItem{fase} di Progettazione Architetturale le ore per ogni ruolo sono state cos\`i suddivise:
...
\begin{table}[H]
	...
	\begin{tabular}{ l c c }
		...
		\hline
	\end{tabular}
	\caption{Ore e costo per ruolo, \glossaryItem{fase} di Progettazione Architetturale}
\end{table}
...
\begin{figure}[H]
  ...
  \caption{Ore per ruolo, \glossaryItem{fase} di Progettazione Architetturale}
  \end{center} 
\end{figure}  
...
\begin{figure}[H]
  ...
  \caption{Costo per ruolo, \glossaryItem{fase} di Progettazione Architetturale}
  \end{center} 
\end{figure}  
...
Nella \glossaryItem{fase} di Progettazione di Dettaglio e Codifica le ore per ogni ruolo sono state così suddivise:
...
\begin{table}[H]
	...
	\begin{tabular}{ l c c }
		...
		\hline
	\end{tabular}
	\caption{Ore e costo per ruolo, \glossaryItem{fase} di Progettazione di Dettaglio e Codifica}
\end{table}
...
\begin{figure}[H]
  ...
  \caption{Ore per ruolo, \glossaryItem{fase} di Progettazione di Dettaglio e Codifica}
  \end{center} 
\end{figure}  
...
\begin{figure}[H]
  ...
  \caption{Costo per ruolo, \glossaryItem{fase} di Progettazione di Dettaglio e Codifica}
  \end{center} 
\end{figure}  
...
%-----------------------------------------------------------------------------------------------------
\subsection{\glossaryItem{Verifica} e \glossaryItem{Validazione}}
Nella \glossaryItem{fase} di \glossaryItem{Validazione} le ore per ogni ruolo sono state cosi suddivise:
...
\begin{table}[H]
	...
	\begin{tabular}{ l c c }
		...
		\hline
	\end{tabular}
	\caption{Ore e costo per ruolo, \glossaryItem{fase} di \glossaryItem{Validazione}}
\end{table}
...
\begin{figure}[H]
  ...
  \caption{Ore per ruolo, \glossaryItem{fase} di \glossaryItem{Validazione}}
  \end{center} 
\end{figure}  
...
\begin{figure}[H]
  ...
  \caption{Costo per ruolo, \glossaryItem{fase} di \glossaryItem{Validazione}}
  \end{center} 
\end{figure}  
...
Il seguente grafico mostra il costo di ogni ruolo durante tutto lo svolgimento del \glossaryItem{progetto}, esclusa la \glossaryItem{fase} di Analisi dei Requisiti.

\begin{figure}[H]
  \begin{center}
    \includegraphics[width=15cm]{res/img/prospettoEconomico/orePerRuoloRiassuntoConAnalisi.png}
  \caption{Ore per ruolo, riassunto \glossaryItem{progetto} con Analisi dei requisiti}
  \end{center} 
\end{figure}  
...
\begin{figure}[H]
  ...
  \caption{Costo per ruolo, riassunto \glossaryItem{progetto} con Analisi dei requisiti}
  \end{center} 
\end{figure}  
...
\begin{figure}[H]
  ...
  \caption{Ore per ruolo, riassunto \glossaryItem{progetto} senza Analisi dei requisiti}
  \end{center} 
\end{figure}  
...
\begin{figure}[H]
  ...
  \caption{Costo per ruolo, riassunto \glossaryItem{progetto} senza Analisi dei requisiti}
  \end{center} 
\end{figure}  
