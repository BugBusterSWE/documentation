...
\toprule
    ...
    \bottomrule
\end{tabular}
\caption{Ore per componente, \glossaryItem{fase} di Analisi}
\end{table}
...
Nella \glossaryItem{fase} di Progettazione Architetturale ciascun componente dovrà rivestire i seguenti ruoli:
...
\toprule
    ...
    \bottomrule
\end{tabular}
\caption{Ore per componente, \glossaryItem{fase} di Progettazione Architetturale}
\end{table}
...
Nella \glossaryItem{fase} di Progettazione di Dettaglio e Codifica ciascun componente dovrà rivestire i seguenti ruoli:
...
\toprule
    ...
    \bottomrule
\end{tabular}
\caption{Ore per componente, \glossaryItem{fase} di Progettazione di dettaglio e codifica}
\end{table}
...
Nella \glossaryItem{fase} di \glossaryItem{Validazione} ciascun componente dovrà rivestire i seguenti ruoli:
...
\toprule
    ...
    \bottomrule
\end{tabular}
\caption{Ore per componente, \glossaryItem{fase} di \glossaryItem{Verifica}}
\end{table}
...
\toprule
    ...
    \bottomrule
\end{tabular}
\caption{Ore per componente totali, inclusa la \glossaryItem{fase} di Analisi}
\end{table}
