...
\begin{center}
  ...
  \begin{longtable}{ | l | p{8cm} |}
	...
	R1D 14 & \glossaryItem{API} del backend: /api/companies/:company\_id/DSLs/:dsl\_id \\ \hline
	
	R1D 15 & \glossaryItem{Package} DSLCreator \newline Interfaccia React \\ \hline

	R1D 15.1 & Componente React \newline \glossaryItem{API} del backend \\ \hline

	R1D 15.2 & Interfaccia React \\ \hline

	R1D 16 & \glossaryItem{Package} DSLCreator \newline Interfaccia React \\ \hline
	...
	R1D 18 & \glossaryItem{Packages} DSLCreator \newline Componente React \\ \hline

	R1D 19 & MaaSSapplication::Lib::AuthenticationChecker \\ \hline

	R1D 20 & Stringa per riferirsi al \glossaryItem{DSL} Element voluto \\ \hline
 
	R1D 21 & Intero per associare il \glossaryItem{DSL} Element voluto \\ \hline

	R1D 22 & Facade \newline Builder \newline tutte le interfacce del \glossaryItem{package} DSLCreator \newline Componente React \\ \hline
	...
	R1D 26 & Componente React \newline \glossaryItem{API} del back-end \\ \hline
	...
	R1D 33 & Componente React \newline \glossaryItem{API} del back-end: /api/companies/:company\_id/DSLs \newline CodeMirror \\ \hline
