...
L'implementazione scelta per il backend dell'applicazione è un server con architettura \glossaryItem{REST}. Ciò implica che:
\begin{itemize}
...
Il ruolo di Controller tuttavia, non essendo implementato nativamente dal \glossaryItem{framework} Express, verrà implementato da uno stack di \glossaryItem{middleware} come suggerito dalla documentazione del \glossaryItem{framework} stesso.
...
\paragraph{Model}
\paragraph*{Descrizione}
Interfaccia comune a tutti i modelli usati da \glossaryItem{MaaS}.
...
\begin{verbatim}
{
    "code":     [Codice definito nel protocollo \glossaryItem{HTTP}, che identifica univocamente
...
\textbf{Descrizione:} Metodo per la creazione di un utente invitato da una \glossaryItem{Company}. Necessita di una richiesta con \textit{body} contenete le informazioni per la creazione completa di un utente \\
\textbf{Scenario:} 
\begin{figure}[H]
\centering
...
\textbf{Descrizione:} Necessita di una richiesta con \textit{body} contenente le informazioni relative alla \glossaryItem{company} e alla creazione del profilo del suo \glossaryItem{Owner}. \\
\textbf{Scenario:} 
\begin{figure}[H]
\centering
...
\textbf{Livello di accesso minimo:} GUEST \\
\textbf{Descrizione:} Ritorna le informazioni generali di una \glossaryItem{Company} \\
\textbf{Scenario:} 
\begin{figure}[H]
\centering
...
\textbf{Descrizione:} Necessita di una richiesta con \textit{body} contenente le modifiche da apportare ai dati della \glossaryItem{Company}. \\
\textbf{Scenario:} 
\begin{figure}[H]
\centering
...
\textbf{Livello di accesso minimo:} GUEST \\
\textbf{Descrizione:} Ritorna un array contenente le specifiche \glossaryItem{DSL} alle quali l'utente ha accesso in formato \glossaryItem{JSON}. \\
\textbf{Scenario:} 
\begin{figure}[H]
\centering
...
\textbf{API:} /api/companies/:company\_id/DSLs \\
\textbf{Livello di accesso minimo:} MEMBER \\
\textbf{Descrizione:} Necessita di una richiesta con \textit{body} contenente i dati necessari alla creazione della specifica \glossaryItem{DSL}. \\
\textbf{Scenario:} 
\begin{figure}[H]
\centering
...
\textbf{API:} /api/companies/:company\_id/DSLs/:dsl\_id \\
\textbf{Livello di accesso minimo:} MEMBER \\
\textbf{Descrizione:} Necessita di una richiesta con body contenente i dati necessari alla modifica della specifica \glossaryItem{DSL} identificata da dsl\_id. \\
\textbf{Scenario:}
\begin{figure}[H]
\centering
...
\textbf{API:} /api/companies/:company\_id/DSLs/:dsl\_id \\
\textbf{Livello di accesso minimo:} MEMBER \\
\textbf{Descrizione:} Ritorna un messaggio in formato \glossaryItem{JSON} di avvenuta cancellazione. \\
\textbf{Scenario:} 
\begin{figure}[H]
\centering
...
\textbf{Livello di accesso minimo:} GUEST \\
\textbf{Descrizione:} Ritorna la \glossaryItem{Dashboard} di un utente definita da una \glossaryItem{DSL}. \\
\textbf{Scenario:}  
\begin{figure}[H]
\centering
...
\textbf{Livello di accesso minimo:} GUEST \\
\textbf{Descrizione:} Ritorna un \glossaryItem{JSON} contenente i dati richiesti dalla specifica \glossaryItem{DSL} e la struttura su cui inserire i dati. \\
\textbf{Scenario:} 
\begin{figure}[H]
\centering
...
\textbf{API:} /api/companies/:company\_id/databases/:database\_id \\
\textbf{Livello di accesso minimo:} ADMIN \\
\textbf{Descrizione:} Elimina il database selezionato e tutte le specifiche \glossaryItem{DSL} che lo utilizzano. \\
\textbf{Scenario:} 
\begin{figure}[H]
\centering
...
\textbf{Livello di accesso minimo:} MEMBER \\
\textbf{Descrizione:} Ritorna un array di \glossaryItem{Collection} relative ad un database a cui l'utente ha accesso. \\
\textbf{Scenario:} 
\begin{figure}[H]
\centering
...
\textbf{Descrizione:} Restituisce un array di \glossaryItem{JSON} contenenti le informazioni relative alle \glossaryItem{Company} presenti nell'applicazione. \\
\textbf{Scenario:} 
\begin{figure}[H]
\centering
...
\textbf{Descrizione:} Necessita di una richiesta con \textit{body} contenente le informazioni relative all'utente da creare per la \glossaryItem{Company} individuata da \glossaryItem{company}\_id. \\
\textbf{Scenario:} 
\begin{figure}[H]
\centering
