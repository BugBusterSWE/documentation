...
\newpage
\paragraph{Ottenimento delle companies di MaaS}\mbox{}\\
\textbf{Tipologia:} GET \\
\textbf{API:} /api/admin/companies/ \\
\textbf{Descrizione:} Verranno ritornate tutte le companies attualmente registrate a MaaS. La richiesta non necessita di nessuna informazione nel body. \\
\textbf{Scenario:} 
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{res/sections/backend/sequence/(POST)userSA.png} %todo
\caption{Scenario dell'ottenimento delle companies di MaaS}
\end{figure}
