...
\item webAPIs::WebAPIFacade: questa classe viene utilizzata per permettere all'ActionCreator di interagire con le API esposte dal backend.
\item Stores::UserStore: le Action create da UserActionCreator poi vengono utilizzate da UserSotre per aggiornare lo stato dei dati relativi agli utenti nel frontend.
\end{itemize}
...
\paragraph*{Relazione con altre classi}
\begin{itemize}
\item Stores: il Dispatcher fornisce i metodi agli Store dichiarare come instradare correttamente le Action.
\item ActionCreators: il Dispatcher mette a disposizione i metodi per dichiarare quali tipi di Action sono legittime all'interno del frontend.
\end{itemize}
...
\item Dispatcher: UserStore usa i metodi di Dispatcher per dichiarare quali Action è in grado di ricevere ed elaborare.
\end{itemize}
...
\paragraph*{Relazione con altre classi}
\begin{itemize}
\item Dispatcher: CompanyStore usa i metodi di Dispatcher per dichiarare quali Action è in grado di ricevere ed elaborare.
...
\paragraph*{Relazione con altre classi}
\begin{itemize}
\item Dispatcher: DSLStore usa i metodi di Dispatcher per dichiarare quali Action è in grado di ricevere ed elaborare.
