\section{Editor di MaaS}
        ...
        L'editor di \glossaryItem{MaaS} è stato progettato seguendo un approccio bottom-up, ossia progettando prima le componenti ``foglia'', raggruppando in modo coeso funzionalità vicine, e poi i \glossaryItem{package}, per una suddivisione delle componenti ad alto livello.
        ...
        \begin{itemize}
        \item \textbf{Descrizione} \hfill \\
          Questa è l'interfaccia da cui derivano tutti i builder concreti del \glossaryItem{package} \texttt{DSLCreator}.
        \item \textbf{Utilizzo}  \hfill \\
 ...
 \subsubsection{DSLCreator::Action::Action}
                ...
                \end{figure}
                    \begin{itemize}
                        ...
                        \item \textbf{Utilizzo} \hfill \\
                          Questa interfaccia espone le funzionalità di accesso e modifica delle proprieta della \glossaryItem{Action}.
                        \item \textbf{Relazioni con altre classi}
                            \begin{itemize}
