...
\item{Non \`e un framework completo}: non esiste un modello di gestione delle librerie all'interno di Reactjs, cosa di cui altri framework simili, come Emberjs o Angularjs, sono provvisti.
\end{itemize}
\subsection{Flux}
