...
\subsubsection{Svantaggi}
\begin{itemize}
\item \textbf{Non completo}: non ci sono gestori dei modelli dei dati presenti nativamente, cosa che invece è presente in altri \glossaryItem{framework} "concorrenti", come AngularJS o EmberJS.
\end{itemize}
\subsection{MongoDB}
