...
\item \textbf{Flux}, framework JavaScript per la gestione dei dati di applicazioni che usano Reactjs;
...
\end{itemize}
\subsection{Flux}
Flux è l'architettura che Facebook usa per creare applicazioni web client-side. È un complemento a React e usa un flusso di dati unidirezionale. Le applicazioni Flux hanno tre parti principali: il dispathcer, i componenti di memorizzazione e le viste (Reactjs).
\subsubsection{Vantaggi}
\begin{itemize}
