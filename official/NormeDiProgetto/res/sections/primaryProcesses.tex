...
\section{Processi primari}
	...
	\subsection{Processo di sviluppo}
		...
		\paragraph*{3. Attività di Codifica}
                ...
                \item \textit{no-swith-case-fall-through}: questa regola impedisce l'utilizzo di \textit{switch} senza l'utilizzo della \textit{keyword} \texit{break} per ogni caso. In questa maniera vengono evitati errori in cui tutti i casi successivi a quello voluto vengano eseguiti involontariamente;
