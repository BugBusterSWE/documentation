...
Le revisioni, specificate nel \PianoDiProgetto, consistono in \glossaryItem{review} e \glossaryItem{audit}, ma essendo le modalit\`a con cui vengono affrontate dal gruppo le medesime verranno denominate presentazioni o revisioni. Secondo quanto indicato nell'IEEE 1028, vengono stabilite le seguenti procedure:
\begin{enumerate}
	\setcounter{enumi}{-1}
