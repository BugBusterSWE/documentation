...
In questa maniera vengono inseriti dei \glossaryItem{CI} (\textit{Configuration Item}) che sono stati verificati sia da sistemi di integrazione continua e sia da umani, coprendo rispettivamente la parte prettamente sintattica (scrittura di codice corretto) e la parte di contenuto (che una macchina non pu\`o controllare), comportando nel repository l'inserimento di codice sempre corretto e verificato e generando \glossaryItem{baseline} sempre consistenti.
