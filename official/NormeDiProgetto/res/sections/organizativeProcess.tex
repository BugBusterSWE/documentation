...
\paragraph*{Assegnazione \glossaryItem{verifica} delle pull request} Le pull request create dall'assegnatario di un \glossaryItem{task} per la \glossaryItem{verifica} sono assegnate in automatico. L'assegnatario di un \glossaryItem{task}, nel momento di creazione di una Pull Ruquest, dovrà lasciare vuoto il campo \textit{Assignee}. Il procedimento d'assegnazione dovrà valutare il verificatore in base ai seguenti criteri:
\begin{itemize}
