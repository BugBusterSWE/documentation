...
\paragraph*{Assegnazione verifica delle pull request} Le pull request create dall'assegnatario di un task per la verifica sono assegnate in automatico da ButlerBusters, senza coinvolgere il responsabile. Il fine \`e di diminuire il tempo di verifica rimuovendo il tempo richiesto dal responsabile per l'assegnazione della pull request.
