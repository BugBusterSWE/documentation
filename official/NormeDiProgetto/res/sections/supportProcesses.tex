...
\subsubsection{2. Attivit\`a di progetto e sviluppo}   %NUOVO  
  \paragraph*{Struttura comune dei documenti}
      ...
      \item tabella riassuntiva del documento riportante:
        ...
        \item Nome e cognome del responsabile del \glossaryItem{progetto} che approva il documento;
...
\begin{itemize}
	...
	\item \textbf{Immagini} \\
		...
		Qualora le immagini non possano essere salvate in formato vettoriale, si preferisce il formato JPEG.
...
A seguito viene descritto il \glossaryItem{processo} di \glossaryItem{verifica} per la documentazione affinchè i Verificatori possano garantire che al termine del loro lavoro, la documentazione prodotta sia conforme alla struttura decisa dal \glossaryItem{Team} e che sia corretta rispetto alle regole decise dal Gruppo e dal punto di vista sintattico per il linguaggio deciso per il documento.
