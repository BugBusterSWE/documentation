...
\begin{center}
  ...
  \begin{longtable}{ | l | p{2cm} | p{4.7cm} | p{2cm} |}
    ...
    R1D 28 & Funzionale \newline Desiderabile & L'utente attraverso l'interfaccia grafica visualizza l'insieme degli attributi di un DSL obbligatori e opzionali distinti attravero una simbolo grafico. & UC-E2.0.6\\ \hline
