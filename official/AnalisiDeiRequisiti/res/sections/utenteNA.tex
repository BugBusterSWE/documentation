...
\subsubsection{Creazione account di una \glossaryItem{Company}}
...
\subsubsection{Inserimento nome \glossaryItem{Company}}    
...
\subsubsection{Inserimento indirizzo email dell'\glossaryItem{Owner}}    
...
\subsubsection{Messaggio d’errore per \glossaryItem{Company} già esistente}   
...
\subsubsection{Registrazione Utente}
    ...
    %Tabella 
    \begin{center}
      %1) L'esito dice che il processo di registrazione non è chiaro
