...
\subsubsection{UC-U4.1}  
    ...
    \begin{center}
      ...
      \begin{longtable}{  p{3.5cm} | p{8cm} } 
        ...
        \textbf{Postcondizioni} & Il campo testo \`e stato compilato con il contenuto richiesto. \\ 
        %1) Aggiungere 'Scenario principale', richiesta di Tullio
      \end{longtable}
      \egroup
    \end{center} 
...
\subsubsection{UC-U6}
    ...
    \begin{center}
      ...
      \begin{longtable}{  p{3.5cm} | p{8cm} } 
        ...
        \textbf{Attori Primari} & Utente non autenticato \\ 
        %1) The professor says: who's the sender of the secret code? The dispatch should be made during the password recovery procedure
