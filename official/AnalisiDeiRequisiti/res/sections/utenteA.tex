...
\subsubsection{Visualizzazione messaggio d'errore}
    ...
    \begin{center}
      ...
      \begin{longtable}{  p{3.5cm} | p{8cm} } 
        ...
        \textbf{Precondizioni}  & L'\glossayItem{Owner} non inserisce correttamente il nome della \glossaryItem{Company}. \\ 
        
        \textbf{Postcondizioni} & L'\glossayItem{Owner} ha visualizzato il messaggio di errore. \\ 
      \end{longtable}
      \egroup
    \end{center}
