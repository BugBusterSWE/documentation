...
\subsubsection{Operazioni sul profilo}
    ...
    \begin{center}
      ...
      \begin{longtable}{  p{3.5cm} | p{8cm} } 
        ...
        \textbf{Attori Primari} & Utente autenticato \\ 
        \textbf{Scopo e Descrizione} & L'utente autenticato visualizza la pagina per apportare modifiche al profilo personale. Può decidere di: modificare l'indirizzo email (l'indirizzo e-mail è modificabile in quanto è unico e non chiave primaria), la password, o rimuovere il profilo.  \\ 
...
%future code for UML
    %\begin{figure}[H]
    %  \begin{center}
    %    \includegraphics[width=12cm]{res/img/UCUtenti/UCUtenteA/UC-U9.4-Procedura Rimozione/UC-U9.4.png}
    %  \caption{UC-U9.2 - Procedura Rimozione}
    %  \end{center} 
    %\end{figure}
    ...
    \begin{center}
      ...
      \begin{longtable}{  p{3.5cm} | p{8cm} } 
        ...
        \textbf{Scopo e Descrizione} & L'\glossaryItem{Owner} decide di rimuovere la \glossaryItem{Company} con tutte le sue informazioni e i suoi utenti e verrà avvisato opportunamente per evitare rimozioni involontarie. \\ 
        
        \textbf{Precondizioni}  & L'\glossaryItem{Owner} inizia la procedura di cancellazione della \glossaryItem{Company} da MaaS. \\ 
        
        \textbf{Postcondizioni} & L'\glossaryItem{Owner} ha superato la procedura di controllo per la cancellazione . \\ 
      \end{longtable}
      \egroup
    \end{center}
...
\subsubsection{Rimozione \glossaryItem{Company}}
    ...
    \begin{center}
      ...
      \begin{longtable}{  p{3.5cm} | p{8cm} } 
        ...
        \hline
        \multicolumn{2}{ | c | }{ \cellcolor[gray]{0.9} \textbf{UC-U9.4.1 - Rimozione \glossaryItem{Company}}} \\ 
        \hline
...
\subsubsection{Operazioni sulle specifiche DSL}
        ...
        \begin{center}
          ...
          \begin{longtable}{  p{3.5cm} | p{8cm} } 
            ...
            \textbf{Attori Primari} & Utente Autenticato, \glossaryItem{Guest}, \glossaryItem{Member}, Admin, \glossaryItem{Owner} \\ 
            ...
            \textbf{Scenario principale} & 1. \glossaryItem{Guest}, \glossaryItem{Member}, l'Admin e l'\glossaryItem{Owner} possono eseguire una specifica DSL (UC-U11.1)  
            
            2. \glossaryItem{Member}, l'Admin e l'\textit{Owner} possono modificare una specifica DSL (UC-U11.2)
            
            3. \glossaryItem{Member}, l'Admin e l'\glossaryItem{Owner} possono creare una specifica DSL (UC-U11.3)
            
            4. \glossaryItem{Member}, l'Admin e l'\textit{Owner} possono leggere una specifica DSL (UC-U11.4)\\
...
\subsubsection{Esecuzione specifica DSL}
                ...
                \begin{center}
                  ...
                  \begin{longtable}{  p{3.5cm} | p{8cm} } 
                    ...
                    \textbf{Attori Primari} & Utente Autenticato, \glossaryItem{Guest}, \glossaryItem{Member}, Admin, \textit{Owner}  \\ 
                    \textbf{Scopo e Descrizione} & L'Utente Autenticato, \glossaryItem{Guest}, \glossaryItem{Member}, Admin, \textit{Owner} eseguono una specifica DSL\\ 
...
\subsubsection{Modifica specifica DSL}
                ...
                \begin{center}
                  ...
                  \begin{longtable}{  p{3.5cm} | p{8cm} } 
                    ...
                    \textbf{Attori Primari} & \glossaryItem{Member}, Admin, \textit{Owner}  \\ 
                    \textbf{Scopo e Descrizione} & \glossaryItem{Member}, Admin, \textit{Owner} modificano una specifica DSL tramite l'editor\\ 
...
\subsubsection{Creazione specifica DSL}
                ...
                \begin{center}
                  ...
                  \begin{longtable}{  p{3.5cm} | p{8cm} } 
                    ...
                    \textbf{Attori Primari} & \glossaryItem{Member}, Admin, \textit{Owner}  \\ 
                    \textbf{Scopo e Descrizione} & \glossaryItem{Member}, Admin, \textit{Owner} creano una specifica DSL tramite l'editor\\ 
...
\subsubsection{Lettura specifica DSL}
                ...
                \begin{center}
                  ...
                  \begin{longtable}{  p{3.5cm} | p{8cm} } 
                    ...
                    \textbf{Attori Primari} & \glossaryItem{Member}, Admin, \textit{Owner}  \\ 
                    \textbf{Scopo e Descrizione} & \glossaryItem{Member}, Admin, \textit{Owner} leggono una specifica DSL\\ 
...
\subsubsection{Visualizzazione di messaggio di errore per violazione dei permessi}
        ...
        \begin{center}
          ...
          \begin{longtable}{  p{3.5cm} | p{8cm} } 
            ...
            \textbf{Precondizioni}  & L'utente autenticato ha eseguito un'operazione su una specifica DSL di cui non dispone i permessi. \\ 
...
\subsubsection{Operazioni sugli Utenti}
        ...
        \begin{center}
          ...
          \begin{longtable}{  p{3.5cm} | p{8cm} } 
            ...
            \textbf{Precondizioni}  & L' \glossaryItem{Owner} e l' \glossaryItem{Admin} dispongono dei permessi per invitare/rimuovere/inserire nuovi utenti nella \glossaryItem{Company} di appartenenza.\\
