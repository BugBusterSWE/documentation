...
\subsubsection{UC-U13}
        ...
        \begin{center}
          ...
          \begin{longtable}{  p{3.5cm} | p{8cm} } 
            ...
            %The professor says: revise the preconditions
...
\subsubsection{UC-U16.1}
   %1) The professor says: what do the children use-cases share?
    %Tabella 
    \begin{center}
      \bgroup
      \def\arraystretch{1.8}     
...
\subsubsection{UC-U16.7.4}
    %1) The professor says: revise the relationship between this use-case and its extension
    %Tabella 
    \begin{center}
      \bgroup
      \def\arraystretch{1.8}     
