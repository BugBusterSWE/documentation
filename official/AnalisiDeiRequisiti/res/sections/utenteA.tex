...
\subsubsection{Operazioni sugli Utenti}
        ...
        \begin{center}
          ...
          \begin{longtable}{  p{3.5cm} | p{8cm} } 
            ...
            \textbf{Precondizioni}  & L'Admin dispone dei permessi per modificare i permessi in lettura/scrittura a una specifica DSL. L' \glossaryItem{Owner} dispone dei permessi per invitare/rimuovere/inserire nuovi utenti alla \glossaryItem{Company} di appartenenza.\\
