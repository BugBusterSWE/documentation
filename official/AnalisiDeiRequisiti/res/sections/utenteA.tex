...
\subsubsection{Visualizzazione messaggio di errore: password errata}
    ...
    \begin{center}
      ...
      \begin{longtable}{  p{3.5cm} | p{8cm} } 
        ...
        \textbf{Attori Primari} & Utente autenticato \\ 
        \textbf{Scopo e Descrizione} & L'Utente Autenticato visualizza un messaggio di errore durante \glossaryItem{procedura} di modifica del profilo dovuto all'inserimento di una password errata. \\ 
...
\subsubsection{Operazioni sugli elementi della Dashboard}
    ...
    \begin{center}
      ...
      \begin{longtable}{  p{3.5cm} | p{8cm} } 
        ...
        \textbf{Scenario principale} & 1.1 L'utente visualizza una \glossaryItem{Cell} (UC-U16.2)
...
\subsubsection{Modifica Collection di un database esistente}
    ...
    \begin{center}
      ...
      \begin{longtable}{  p{3.5cm} | p{8cm} } 
        ...
        \textbf{Postcondizioni} & L'applicazione hamodificato la \glossaryItem{Collection}. \\ 
...
\subsubsection{Modifica nome Collection}
    ...
    \begin{center}
      ...
      \begin{longtable}{  p{3.5cm} | p{8cm} } 
        ...
        \hline
        \multicolumn{2}{ | c | }{ \cellcolor[gray]{0.9} \textbf{UC-U18.1.5.2.2.1 - Inserimento nome \glossaryItem{Collection}}} \\ 
        \hline
