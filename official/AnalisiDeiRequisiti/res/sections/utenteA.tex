...
%future code for UML
    ...
    \begin{center}
      ...
      \begin{longtable}{  p{3.5cm} | p{8cm} } 
        ...
        \textbf{Scopo e Descrizione} & L'\glossaryItem{Owner} decide di rimuovere la \glossaryItem{Company} con tutte le sue informazioni e i suoi utenti e verranno avvisati opportunamente per evitare rimozioni involontarie. \\ 
...
\subsubsection{Operazioni sulle specifiche DSL}
        ...
        \begin{center}
          ...
          \begin{longtable}{  p{3.5cm} | p{8cm} } 
            ...
            2. \glossaryItem{Member}, l'Admin e l'\glossaryItem{Owner} possono modificare una specifica DSL (UC-U11.2)
            
            3. \glossaryItem{Member}, l'Admin e l'\glossaryItem{Owner} possono creare una specifica DSL (UC-U11.3)
            
            4. \glossaryItem{Member}, l'Admin e l'\glossaryItem{Owner} possono leggere una specifica DSL (UC-U11.4)\\
...
\subsubsection{Esecuzione specifica DSL}
                ...
                \begin{center}
                  ...
                  \begin{longtable}{  p{3.5cm} | p{8cm} } 
                    ...
                    \textbf{Attori Primari} & Utente Autenticato, \glossaryItem{Guest}, \glossaryItem{Member}, Admin, \glossaryItem{Owner}  \\ 
                    \textbf{Scopo e Descrizione} & L'Utente Autenticato, \glossaryItem{Guest}, \glossaryItem{Member}, Admin, \glossaryItem{Owner} eseguono una specifica DSL\\ 
...
\subsubsection{Modifica specifica DSL}
                ...
                \begin{center}
                  ...
                  \begin{longtable}{  p{3.5cm} | p{8cm} } 
                    ...
                    \textbf{Attori Primari} & \glossaryItem{Member}, Admin, \texglossaryItemtit{Owner}  \\ 
                    \textbf{Scopo e Descrizione} & \glossaryItem{Member}, Admin, \glossaryItem{Owner} modificano una specifica DSL tramite l'editor\\ 
...
\subsubsection{Creazione specifica DSL}
                ...
                \begin{center}
                  ...
                  \begin{longtable}{  p{3.5cm} | p{8cm} } 
                    ...
                    \textbf{Attori Primari} & \glossaryItem{Member}, Admin, \glossaryItem{Owner}  \\ 
                    \textbf{Scopo e Descrizione} & \glossaryItem{Member}, Admin, \glossaryItem{Owner} creano una specifica DSL tramite l'editor\\ 
...
\subsubsection{Lettura specifica DSL}
                ...
                \begin{center}
                  ...
                  \begin{longtable}{  p{3.5cm} | p{8cm} } 
                    ...
                    \textbf{Attori Primari} & \glossaryItem{Member}, Admin, \glossaryItem{Owner}  \\ 
                    \textbf{Scopo e Descrizione} & \glossaryItem{Member}, Admin, \glossaryItem{Owner} leggono una specifica DSL\\ 
