...
3. L'utente pu\`o salvare la specifica \glossaryItem{DSL}. (UC-E3)
    ...
    \subsubsection{Importazione di una specifica \glossaryItem{DSL} esistente}    
    ...
    \begin{center}
      ...
      \begin{longtable}{  p{3.5cm} | p{8cm} } 
        ...
        \textbf{Attori Primari} &  \glossaryItem{Member}, \glossaryItem{Admin}, \glossaryItem{Owner} \\ 
        \textbf{Scopo e Descrizione} & L'utente pu\`o importare una specifica \glossaryItem{DSL} esistente tra quelli personali o quelli della Company. \\ 
...
\subsubsection{Manipolazione di un \glossaryItem{DSL Element}}
    ...
    \begin{center}
     % UC-E2: i suoi sotto-casi d’uso sono generici: come si interseca questo fatto
             %con i suoi casi derivati? Ognuno di questi dovrebbe avere una sua
...
\subsubsection{Aggiunta di un \glossaryItem{DSL Element}}   
...
\subsubsection{Compilazione campi del \glossaryItem{DSL Element}}
...
\subsubsection{Associare un insieme di \glossaryItem{DSL Elements} ad un attributo}
    ...
    \begin{center}
      ...
      \egroup
    \end{center}
\subsubsection{Rimuovere un \glossaryItem{DSL Element}}
    ...
    \begin{center}
      ...
      \egroup
    \end{center}
\subsubsection{Associare un \glossaryItem{Function Element} ad un attributo}
...
\subsubsection{Accedere ai campi opzionali di un \glossaryItem{DSL Element}}
...
\subsubsection{Manipolazione di un \glossaryItem{Collection Element}}
...
\subsubsection{Associare un \glossaryItem{Index Element} ad un \glossaryItem{Collection Element}}
...
\subsubsection{Associare un \glossaryItem{Document Element} ad un \glossaryItem{Collection Element}}
...
\subsubsection{Manipolare un \glossaryItem{Function Element}}
    \begin{figure}[H]
      \begin{center}
...
3. L'utente ha la possibilit\`a di importare \glossaryItem{Function Element}. (UC-E2.2.3)  \\
      ...
      \egroup
    \end{center}
\subsubsection{Definizione di un \glossaryItem{Function Element}}
    ...
    \begin{center}
      ...
      \egroup
    \end{center}
\subsubsection{Salvataggio di un \glossaryItem{Function Element}}
...
\subsubsection{Importare un \glossaryItem{Function Element}}
...
\subsubsection{Manipolare un \glossaryItem{Index Element}}
    \begin{figure}[H]
      \begin{center}
...
4. L'utente ha la possibilit\'a di associare un \glossaryItem{Column Element}. (UC-E2.3.2)
      ...
      \egroup
    \end{center}
\subsubsection{Aggiungere/Rimuovere un attributo \glossaryItem{Column}}
    ...
    \begin{center}
      ...
      \egroup
    \end{center}
\subsubsection{Associare un \glossaryItem{Column Element} ad un \glossaryItem{Index Element}}
...
\subsubsection{Manipolazione di un \glossaryItem{Column Element}}
...
\subsubsection{Manipolazione di \glossaryItem{Row Element}}
    ...
    \begin{center}
      ...
      \egroup
    \end{center}
\subsubsection{Manipolazione un \glossaryItem{Document Element}}
...
4. L'utente pu\`o associare agganciare un \glossaryItem{Action Element} ad un \glossaryItem{Document Element}. (UC-E2.6.4) 
      ...
      \egroup
    \end{center}
\subsubsection{Aggiungere un riferimento ad un \glossaryItem{Column Element}}
...
\subsubsection{Aggiungere/Rimuovere un attributo \glossaryItem{Row}}
    ...
    \begin{center}
      ...
      \egroup
    \end{center}
\subsubsection{Associare un \glossaryItem{Row Element} ad un attributo \glossaryItem{Row}}
    ...
    \begin{center}
      ...
      \egroup
    \end{center}
\subsubsection{Associare un \glossaryItem{Action Element}}
    ...
    \begin{center}
      ...
      \egroup
    \end{center}
\subsubsection{Manipolazione di un \glossaryItem{Input Element}}
...
3. L'utente pu\`o aggiungere ad un attributo dei sottoattributi. (UC-E2.7.3)
      ...
      \egroup
    \end{center}
\subsubsection{Creare/Eliminare un nuovo attributo dell'\glossaryItem{Input Element}}
    ...
    \begin{center}
      ...
      \egroup
    \end{center}
\subsubsection{Modificare un attributo dell'\glossaryItem{Input Element}}
...
\subsubsection{Manipolazione di un \glossaryItem{Cell Element}}
...
\subsubsection{Selezionare il tipo del dato associato al \glossaryItem{Cell Element}}
...
\subsubsection{Manipolazione di un \glossaryItem{Dashboard Element}}
...
\subsubsection{Associare un \glossaryItem{DashRow Element} ad un \glossaryItem{Dashboard Element}}
    ...
    \begin{center}
      ...
      \egroup
    \end{center}
\subsubsection{Aggiungere/Rimuovere un attributo \glossaryItem{Row} dal \glossaryItem{Dashboard Element}}
...
\subsubsection{Manipolazione di un \glossaryItem{DashRow Element}}
...
3. L'utente pu\`o associare un \glossaryItem{Collection Element} al \glossaryItem{DashRow Element}. (UC-E2.10.3)
      ...
      \egroup
    \end{center}
\subsubsection{Associare un \glossaryItem{Cell Element} al \glossaryItem{DashRow Element}}
    ...
    \begin{center}
      ...
      \egroup
    \end{center}
\subsubsection{Associare un \glossaryItem{Document Element} al \glossaryItem{DashRow Element}}
    ...
    \begin{center}
      ...
      \egroup
    \end{center}
\subsubsection{Associare un \glossaryItem{Collection Element} ad un \glossaryItem{DashRow Element}}
    ...
    \begin{center}
      ...
      \egroup
    \end{center}
\subsubsection{Definire un \glossaryItem{Action Element}}
...
2. L'utente seleziona il tipo d'azione per l'\glossaryItem{Action Element}. (UC-E2.11.2) 
      ...
      \egroup
    \end{center}
\subsubsection{Selezione input per \glossaryItem{Action Element}}
...
\subsubsection{Selezione tipo d'azione per l'\glossaryItem{Action Element}}
    %Tabella 
    \begin{center}
      \bgroup
      \def\arraystretch{1.8}     
...
\subsubsection{Salvataggio specifica \glossaryItem{DSL}}
     %UC-E3: rivedere perché
     % contiene dettagli tecnici, ossia casi d’uso per i quali non è associato alcun
     % attore
    ...
    \begin{center}
      ...
      \egroup
    \end{center}
\subsubsection{Richiedere il salvataggio della specifica \glossaryItem{DSL}}
    ...
    \begin{center}
      ...
      \egroup
    \end{center}
\subsubsection{Validazione del \glossaryItem{DSL}}
...
\subsubsection{Memorizzazione della specifica \glossaryItem{DSL}}
    ...
    \begin{center}
      ...
      \begin{longtable}{  p{3.5cm} | p{8cm} } 
        ...
        \hline
        \textbf{Attori Primari} &  \glossaryItem{Member}, \glossaryItem{Admin}, \glossaryItem{Owner} \\ 
         \textbf{Scopo e Descrizione} &  Il sistema esegue la procedura di memorizzazione della specifica \glossaryItem{DSL}. \\ 
      ...
      \egroup
    \end{center}
\subsubsection{La specifica \glossaryItem{DSL} non \`e valida}
