...
\subsubsection{Aggiungere un riferimento ad un Column Element}
    ...
    \begin{center}
      ...
      \begin{longtable}{  p{3.5cm} | p{8cm} } 
        ...
        \textbf{Scenario principale} & 1. L'utente aggiunge un'\glossaryItem{associazione per riferimento} tra il \glossaryItem{Column Element} e l'attributo \glossaryItem{Populate} del \glossaryItem{Document Element}. \\ 
      \end{longtable}
      \egroup
    \end{center}
