...
Il gruppo ha individuato i seguenti requisiti minimi sui \textit{browser} supportati da MaaS:
\begin{itemize}
\item textbf{\textit{Google Chrome}}, versione 48.x;
\item textbf{\textit{Mozilla Firefox}}, versione 45.x.
\end{itemize}
