...
\subsubsection{Modifica del livello di permesso}
    ...
    \begin{center}
      ...
      \begin{longtable}{  p{3.5cm} | p{8cm} } 
        ...
        \hline
        \multicolumn{2}{ | c | }{ \cellcolor[gray]{0.9} \textbf{UC-S2.3.0 - Modifica del livello di permesso }} \\ 
        \hline
        ...
        \textbf{Postcondizioni} & Il ruolo dell'utente selezionato è cambiato. \\ 
         \textbf{Scenario principale} & 1. Il \glossaryItem{Super-Admin} seleziona il nuovo ruolo dell'utente di MaaS in un form offerto dall'applicazione.   
