...
\subsubsection{Creazione di una nuova Company}
    ...
    \begin{center}
      ...
      \begin{longtable}{  p{3.5cm} | p{8cm} } 
        ...
        2. Il \glossaryItem{Super-Admin} inserisce l'indirizzo email dell'\glossaryItem{Owner}. (UC-S1.1)
        
        3. Il \glossaryItem{Super-Admin} inserisce la password dell'\glossaryItem{Owner}. (UC-S1.2) \\ 
