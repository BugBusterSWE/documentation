...
%%DA FARE
    ...
    \begin{center}
      ...
      \begin{longtable}{  p{3.5cm} | p{8cm} } 
        ...
        \textbf{Attori Primari} & \glossaryItem{Super-Admin}\\  
        \textbf{Scopo e descrizione} & L'\glossaryItem{Attore} L'applicazione dispone un campo testo su cui l'attore può scrivere il nome della \glossaryItem{Company} \\
      
        \textbf{Precondizioni}  & L'applicazione dispone un campo testo graficamente. \\ 
        
        \textbf{Postcondizioni} & L'utente ha compilato il campo testo relativo al nome della \glossaryItem{Company} \\ 
     \end{longtable}
      \egroup
    \end{center}


\subsubsection{UC-S1.1} 
    ...
    \begin{center}
      ...
      \begin{longtable}{  p{3.5cm} | p{8cm} } 
        ...
        \textbf{Attori Primari} & \glossaryItem{Super-Admin}\\  
        \textbf{Scopo e descrizione} & L'\glossaryItem{Attore} L'attore può inserire l'indirizzo email dell'\glossaryItem{Owner} nel campo del form disposto dall'applicazione \\
      
        \textbf{Precondizioni}  & L'applicazione dispone un campo testo graficamente. \\ 
        
        \textbf{Postcondizioni} & L'utente ha compilato il campo testo relativo all'email dell'\glossaryItem{Owner} \\ 
     \end{longtable}
      \egroup
    \end{center}

    \subsubsection{UC-S1.2} 
    ...
    \begin{center}
      ...
      \begin{longtable}{  p{3.5cm} | p{8cm} } 
        ...
        \textbf{Attori Primari} & \glossaryItem{Super-Admin}\\  
        \textbf{Scopo e descrizione} & L'\glossaryItem{Attore} L'applicazione dispone un campo testo offuscato su cui l'attore può scrivere la password dell'\glossaryItem{Owner} \\
      
        \textbf{Precondizioni}  & L'applicazione visualizza un campo testo offuscato. \\ 
        
        \textbf{Postcondizioni} & L'utente ha compilato il campo testo relativo alla password dell'\glossaryItem{Owner} \\ 
     \end{longtable}
      \egroup
    \end{center}
...
\subsubsection{UC-S4} 
    ...
    \begin{center}
      ...
      \begin{longtable}{  p{3.5cm} | p{8cm} } 
        ...
        \hline
        \multicolumn{2}{ | c | }{ \cellcolor[gray]{0.9} \textbf{UC-S4 - Fallisce la creazione di una Company }} \\ 
        \hline
        
        \textbf{Attori Primari} & \glossaryItem{Super-Admin}\\  
        \textbf{Scopo e descrizione} & L'\glossaryItem{Attore} ha inserito dei dati errati per la creazione della Company e il sistema comunica l'errore. \\
      
        \textbf{Precondizioni}  & L'applicazione ha ricevuto in input dei dati per la creazione di una Company che non sono validi. \\ 
        
        \textbf{Postcondizioni} & Il sistema fa visualizzare all'utente un messaggio di errore che comunica l'entità dell'input errato. \\ 
         \textbf{Scenario principale} & 1. L'utente visualizza l'errore. \\
    ...
    \begin{center}
      ...
      \begin{longtable}{  p{3.5cm} | p{8cm} } 
        ...
        \hline
        \multicolumn{2}{ | c | }{ \cellcolor[gray]{0.9} \textbf{UC-S4 - Fallisce la modifica di una Company }} \\ 
        \hline
        
        \textbf{Attori Primari} & \glossaryItem{Super-Admin}\\  
        \textbf{Scopo e descrizione} & L'\glossaryItem{Attore} ha inserito dei dati errati per la modifica della Company e il sistema comunica l'errore. \\
      
        \textbf{Precondizioni}  & L'applicazione ha ricevuto in input dei dati per la modifica di una Company che non sono validi. \\ 
