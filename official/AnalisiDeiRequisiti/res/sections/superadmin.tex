...
\subsubsection{Interazione ad alto livello tra sistema e Super-Admin}
	...
	\textbf{Scopo e descrizione} & Il \glossaryItem{Super-Admin} deve poter gestire le \glossaryItem{Company}.  \\ 
        ...
        \textbf{Estensioni} & 1. Fallisce l'inserimento di una nuova \glossaryItem{Company}. (UC-S4)
        
        2. Fallisce la modifica dei dati di una \glossaryItem{Company}. (UC-S5) \\
      \end{longtable}
      \egroup
    \end{center}
    ...
    \begin{center}
      ...
      \begin{longtable}{  p{3.5cm} | p{8cm} } 
        ...
        \textbf{Postcondizioni} & Il sistema ha modificato il profilo della \glossaryItem{Company} sulla base dei dati inseriti dal \glossaryItem{Super-Admin}.  \\ 
       	 \textbf{Scenario principale} & 1. Il \glossaryItem{Super-Admin} può modificare i dati della \glossaryItem{Company}. \\
...
\subsubsection{Aggiunta di un nuovo utente nella Company selezionata}
	...
	\textbf{Scenario principale} & 1. Il \glossaryItem{Super-Admin} può aggiungere l'email dell'utente (UC-S2.1.0);
        ...
        2. Il \glossaryItem{Super-Admin} può aggiungere la password dell'utente (UC-S2.1);

        3. Il \glossaryItem{Super-Admin} può selezionare il livello di permesso dell'utente (UC-S2.2). \\
...
\subsubsection{Aggiunta dell'email dell'utente}
	...
	\textbf{Scenario principale} & Il Super-Admin può inserire l'email dell'utente da aggiungere.  \\ 
      \end{longtable}
      \egroup
    \end{center}
...
\subsubsection{Aggiunta della password dell'utente}
    ...
    \begin{center}
      ...
      \begin{longtable}{  p{3.5cm} | p{8cm} }
        ...
        \textbf{Scenario principale} & Il Super-Admin può inserire la password dell'utente da aggiungere.  \\
      \end{longtable}
      \egroup
    \end{center}
...
\subsubsection{Selezione del livello di permesso per l'utente}
    ...
    \begin{center}
      ...
      \begin{longtable}{  p{3.5cm} | p{8cm} }
        ...
        \textbf{Scenario principale} & Il Super-Admin può selezionare il livello di permesso dell'utente da aggiungere.  \\
      \end{longtable}
      \egroup
    \end{center}
