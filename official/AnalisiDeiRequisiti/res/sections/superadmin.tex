...
\subsubsection{Interazione ad alto livello tra sistema e Super-Admin}
	...
	\textbf{Scopo e descrizione} & Il \glossaryItem{Super-Admin} deve poter gestire i dati dell'applicazione MaaS.  \\ 
        \textbf{Precondizioni}  & L'applicazione mostra al \glossaryItem{Super-Admin} la pagina di gestione di MaaS.  \\ 
        
        \textbf{Postcondizioni} & L'applicazione ha dato la possibilità al \glossaryItem{Super-Admin} di gestire MaaS. \\ 
...
%%DA FARE
    ...
    \begin{center}
        ...
        \textbf{Estensioni} & 1. Il nome della \glossaryItem{Company} inserito è già presente in MaaS. (UC-S1.3)
     \end{longtable}
      \egroup
    \end{center}
...
\subsubsection{Fallimento della creazione di una Company - Indirizzo email dell'Owner già presente} 
    ...
    \begin{center}
      ...
      \begin{longtable}{  p{3.5cm} | p{8cm} } 
        ...
        \hline
        \multicolumn{2}{ | c | }{ \cellcolor[gray]{0.9} \textbf{UUC-S2 - Gestione in dettaglio di una \glossaryItem{Company} esistente}} \\ 
        \hline
        
        \textbf{Attori Primari} & \glossaryItem{Super-Admin}\\  
        \textbf{Scopo e descrizione} & Il \glossaryItem{Super-Admin} visualizza una pagina contenente i dettagli di una Company e può apportare delle modifiche alla Company o ai suoi utenti. \\
...
\subsubsection{Modifica dei dati di una Company}
    ...
    \begin{center}
      ...
      \begin{longtable}{  p{3.5cm} | p{8cm} } 
        ...
        \textbf{Attori Primari} & \glossaryItem{Super-Admin}.\\  
        \textbf{Scopo e descrizione} & Il \glossaryItem{Super-Admin} visualizza una \textit{form} per la modifica dei dati di una Company. \\
...
\subsubsection{Modifica del livello di permesso}
    ...
    \begin{center}
      ...
      \begin{longtable}{  p{3.5cm} | p{8cm} } 
        ...
        \textbf{Precondizioni}  & L'applicazione offre al \glossaryItem{Super-Admin} una pagina per modificare il ruolo di un utente di MaaS .\\ 
        
        \textbf{Postcondizioni} & Il ruolo dell'utente selezionato è cambiato. \\ 
         \textbf{Scenario principale} & 1. Il \glossaryItem{Super-Admin} seleziona il nuovo ruolo dell'utente di MaaS in un \textit{form} offerto dall'applicazione.   
...
\subsubsection{Modifica della password di un utente}
    ...
    \begin{center}
      ...
      \begin{longtable}{  p{3.5cm} | p{8cm} } 
        ...
        \textbf{Precondizioni}  & L'applicazione offre al \glossaryItem{Super-Admin} una pagina per modificare la password di un utente di MaaS .\\ 
        
        \textbf{Postcondizioni} & La password dell'utente selezionato è cambiata. \\ 
         \textbf{Scenario principale} & 1. Il \glossaryItem{Super-Admin} inserisce la nuova password dell'utente di MaaS in un \textit{form} offerto dall'applicazione.   
    ...
    \subsubsection{Fallimento della modifica di una Company} 
        ...
        \begin{center}
          ...
          \begin{longtable}{  p{3.5cm} | p{8cm} } 
            ...
            \hline
            \multicolumn{2}{ | c | }{ \cellcolor[gray]{0.9} \textbf{UC-S2.5 - Visualizzazione di un messaggio di errore per nome della Company esistente}} \\ 
            \hline
            
            \textbf{Attori Primari} & \glossaryItem{Super-Admin}\\  
            \textbf{Scopo e descrizione} & Il \glossaryItem{Super-Admin} ha inserito un nome di Company già presente nell'applicazione e il sistema comunica l'errore. \\
        ...
        \subsubsection{Fallimento della modifica o inserimento di un utente di una Company} 
                ...
                \begin{center}
                  ...
                  \begin{longtable}{  p{3.5cm} | p{8cm} } 
                    ...
                    \hline
                    \multicolumn{2}{ | c | }{ \cellcolor[gray]{0.9} \textbf{UC-S2.5 - Visualizzazione di un messaggio di errore indirizzo email esistente}} \\ 
                    \hline
...
\subsubsection{Creazione di un Super-Admin}
	...
	\subsubsection{Fallimento dell'aggiunta di un Super Admin} 
	        ...
	        \begin{center}
	          ...
	          \begin{longtable}{  p{3.5cm} | p{8cm} } 
	            ...
	            \hline
	            \multicolumn{2}{ | c | }{ \cellcolor[gray]{0.9} \textbf{UC-S3.2 - Visualizzazione di un messaggio di errore indirizzo email esistente}} \\ 
	            \hline
	            
	            \textbf{Attori Primari} & \glossaryItem{Super-Admin}\\  
	            \textbf{Scopo e descrizione} & Il \glossaryItem{Super-Admin} ha inserito un indirizzo email già presente nell'applicazione e il sistema comunica l'errore. \\
	          
	            \textbf{Precondizioni}  & L'applicazione ha ricevuto in input dei dati non validi per la creazione di un \glossaryItem{Super-Admin}. \\ 
