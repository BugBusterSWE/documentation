...
description = {Insieme di regole che descrivono meccanismi di rappresentazione di testo. Fornisce la possibilità di formattare un testo per mezzo di marcatori, cioè espressionni codificate fornite dalle convenzioni che costituiscono il linguaggio.}
}

\newglossaryentry{png}{
name = portable network graphics,
description = { \textbf{P}ortable \textbf{N}etwork \textbf{G}raphics è un formato di file per la memorizzazione di immagini.}
