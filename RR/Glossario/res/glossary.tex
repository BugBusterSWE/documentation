...
\newglossaryentry{dsl}{
name = DSL,
description = {(Acronimo per Domain-Specific Language) \`e un linguaggio specifico dedicato a particolari problemi di un dominio, a una particolare tecnica di rappresentazione e/o a una particolare soluzione tecnica.}
}
