...
name=merging,
description={\`E la creazione di una nuova versione di un componente ottenuta unendo versioni separate in codeline differenti. Queste codeline possono essere state create da una precedente ramificazione (branc).  [Sommerville, pag 684]}
}
...
%todo: aggiungere 'Angular.js'
%todo: aggiungere 'React.js'
%todo: aggiungere 'back end'
