...
\section{\glossaryItem{Processo} di documentazione}
...
\subsection{Risultati attesi dal \glossaryItem{Processo}}
...
\end{itemize}
  \subsection{\glossaryItem{Procedura}}
...
Al fine di evitare ambiguità o fraintendimenti dovuti all'utilizzo di alcune terminologie deve essere sempre tenuto aggiornato il Glossario. Tale operazione deve essere fatta dagli autori della documentazione che, evidenziato un vocabolo critico, deve provvedere ad inserirlo nel Glossario fornendone una breve descrizione. I vocaboli presenti possono essere utilizzati durante la stesura degli altri documenti riportandoli con la sintassi \glossaryItem{Nome Elemento}

\section{\glossaryItem{Processo} di \glossaryItem{verifica}}
\subsection{Scopo del \glossaryItem{Processo}}
...
\subsection{\glossaryItem{Verifica} dei documenti}
