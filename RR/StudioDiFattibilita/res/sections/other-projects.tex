...
\subsubsection{Aspetti positivi}
L'area di studio del \glossaryItem{progetto} è interessante ed innovativa. Inoltre, tutti i membri
...
in quanto il \glossaryItem{progetto} in questione ha come obiettivo la ricerca di nuovi scenari per la navigazione \textit{indoor}
...
\subsubsection{Aspetti negativi}
Il presente \glossaryItem{progetto} \`e stato considerato scarsamente `sfidante' nelle richieste e nello scopo.
