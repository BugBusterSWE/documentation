...
Il presente documento contiene le strategie di \glossaryItem{verifica} e \glossaryItem{validazione} che il \glossaryItem{team} BugBusters ha deciso di adottare. La ricerca della \glossaryItem{qualità}, nei prodotti e nei processi, non rientra nei ruoli canonici di un progetto, ma è una \glossaryItem{funzione aziendale}; il \glossaryItem{committente}, potrà, attraverso le strategie qui documentate, valutare su basi oggettive il prodotto e disporre di una solida batteria di test.
...
\item \textbf{Slides del corso di Ingegneria del Software mod. A}: \glossaryItem{Qualità} del processo \url{http://www.math.unipd.it/~tullio/IS-1/2015/Dispense/L09.pdf};
