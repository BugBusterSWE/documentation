...
\begin{itemize}
	\item SPICE\footnote{Si veda appendice \ref{AppQualitaProcessi} per approfondimenti} (\textbf{S}imulation \textbf{P}rogram with \textbf{I}ntegrated \textbf{C}ircuit \textbf{E}mphasis): definito nello standard ISO/IEC 15504, per poter valutare in modo oggettivo i processi dal punto di vista della maturità;
