...
Per valutare i processi si è deciso di applicare il modello \textit{CMM} (\textbf{C}apability \textbf{M}aturity \textbf{M}odel). \\
L'indice può assumere valori interi da 1 a 5, dove 1 indica il valore peggiore e 5 il migliore. Si rimanda all'appendice \ref{AppCMM} per approfondimenti.\\
