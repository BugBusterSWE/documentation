...
\subsubsection{\glossaryItem{Qualità} di \glossaryItem{processo}}
La pianificazione delle attività volte al miglioramento continuo dei processi sono descritte nel \PianoDiProgetto. Le linee guida per la gestione della \glossaryItem{qualità} del \glossaryItem{processo}, invece, seguono il modello PCDA e descrivono come devono essere attuate le procedure di controllo:
\begin{itemize}
