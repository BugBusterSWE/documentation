...
\section{Controlli per la \glossaryItem{qualità} di processo}
Le procedure di controllo per la \glossaryItem{qualità} di processo sono finalizzate a migliorare la \glossaryItem{qualità} del prodotto e/o diminuire i costi e tempi di sviluppo. Esistono due approcci principali:
\begin{itemize}
\item \textbf{A maturità di processo}: l'obiettivo primario è la \glossaryItem{qualità} del prodotto e la prevedibilità dei processi;
...
Il processo con maggiore influenza sulla \glossaryItem{qualità} del sistema non è quello di sviluppo ma quello di progettazione. È qui che le capacità e le esperienze dei singoli danno un contributo decisivo.\\
\begin{figure}[h]
...
\item L'analisi viene effettuata i giorni precedenti alle consegne previste dal \glossaryItem{committente}; il \textit{Riassunto delle attività di \glossaryItem{verifica}} (\ref{App:AppendixA}) contiene l'analisi del processo, le relative considerazioni  comprendenti le problematiche riscontrate;
