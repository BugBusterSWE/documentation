...
\item \textit{Pianificazione}: i gruppi di attivit\`a pianificate, relative alle scadenze fissate dal committente, non ricoprono tutto l'arco di tempo a disposizione, lasciando uno \textit{Slack} prima di ogni consegna;
