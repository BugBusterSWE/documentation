...
\item \textit{Probabilit\`a}: Bassa;
\item \textit{Effetti}: Seri;
\item \textit{Pianificazione}: il cambio di requisiti deve svolgersi prima della prima data di revisione del progetto in modo da non rallentare o bloccare i \textit{Progettisti} durante la stesura della Specifica tecnica.
\end{enumarate}
