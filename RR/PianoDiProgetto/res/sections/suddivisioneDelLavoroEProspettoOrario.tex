...
I valori in tabella sono riassunti nel seguente grafico: \\ 
    ...
    \begin{figure}[H]
      \begin{center}
        \includegraphics[width=12cm]{res/img/suddivisioneRuoloProspettoOrario/orePerComponenteAnalisi.png}
      \caption{Ore per componente, fase di Analisi}
      \end{center} 
    \end{figure}    
...
I valori in tabella sono riassunti nel seguente grafico: \\ 
    ...
    \begin{figure}[H]
      \begin{center}
        \includegraphics[width=12cm]{res/img/suddivisioneRuoloProspettoOrario/orePerComponenteAnalisiMiglioramenti.png}
      \caption{Ore per componente, fase di Analisi}
      \end{center} 
    \end{figure}    
...
I valori in tabella sono riassunti nel seguente grafico: \\ 
    ...
    \begin{figure}[H]
      \begin{center}
        \includegraphics[width=12cm]{res/img/suddivisioneRuoloProspettoOrario/orePerComponenteProgettazioneArchitetturale.png}
      \caption{Ore per componente, fase di Progettazione architetturale}
      \end{center} 
    \end{figure}    
...
I valori in tabella sono riassunti nel seguente grafico: \\ 
    ...
    \begin{figure}[H]
      \begin{center}
        \includegraphics[width=12cm]{res/img/suddivisioneRuoloProspettoOrario/orePerComponenteProgettazioneDettaglioCodifica.png}
      \caption{Ore per componente, fase di Progettazione di dettaglio e codifica}
      \end{center} 
    \end{figure}    
...
I valori in tabella sono riassunti nel seguente grafico: \\ 
    ...
    \begin{figure}[H]
      \begin{center}
        \includegraphics[width=12cm]{res/img/suddivisioneRuoloProspettoOrario/orePerComponenteValidazione.png}
      \caption{Ore per componente, fase di Verifica}
      \end{center} 
    \end{figure}    
...
I valori in tabella sono riassunti nel seguente grafico: \\ 
    ...
    \begin{figure}[H]
      \begin{center}
        \includegraphics[width=12cm]{res/img/suddivisioneRuoloProspettoOrario/orePerComponenteTotaliConAnalisi.png}
      \caption{Ore per componente totali, inclusa la fase di Analisi}
      \end{center} 
    \end{figure}    
...
I valori in tabella sono riassunti nel seguente grafico: \\ 
    ...
    \begin{figure}[H]
      \begin{center}
        \includegraphics[width=12cm]{res/img/suddivisioneRuoloProspettoOrario/orePerComponenteTotaliSenzaAnalisi.png}
      \caption{Ore per componente totali, inclusa la fase di Analisi}
      \end{center} 
    \end{figure}    
