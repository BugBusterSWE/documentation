...
\begin{table}[H]
	...
	\cline{3-4}
	PA2.1 & Incremento & Progettista1 & 2\\
	& & Progettista2 & 2\\
    \cline{3-4}
	...
	\cline{3-4}
	PA4.1 & Incremento & Amministratore & 0\\
    \cline{3-4}
	...
	\cline{3-4}
	PA5.1 & Progettazione requisiti fondamentali e desiderabili & Progettista1 & 12\\
	    & & Progettista2 & 14\\
	    & & Progettista3 & 12\\
        \cline{3-4}
	...
	PA5.3 & Stesura requisiti fondamentali e desiderabili & Progettista1 & 5\\
		& & Progettista2 & 5\\
        \cline{3-4}
	PA5.4 & Progettazione requisiti opzionali & Progettista1 & 2\\
		& & Progettista2 & 8\\
		& & Progettista3 & 7\\
		& & Progettista4 & 7\\
        \cline{3-4}
...
\begin{table}[H]
    ...
    \cline{3-4}
	PDC1.2 & Verifica & Verificatore &  4\\
	
	\hline
	\textbf{PDC2} & \textbf{Piano di Qualifica} \\
	\cline{3-4}
	PDC2.1 & Incremento & Progettista & 3\\
    \cline{3-4}
	PDC2.2 & Verifica & Verificatore & 4\\
	
	\hline
	\textbf{PDC3}  & \textbf{Piano di progetto} \\
	\cline{3-4}
	PDC3.1 & Incremento & Amministratore & 2\\
	& & Responsabile & 6\\
	& & Responsabile & 5\\
    \cline{3-4}
	PDC3.2 & Verifica AN & Verificatore & 5\\
	...
	\hline
	\textbf{PCD5} & \textbf{Preparazione Ambiente di lavoro} & Amministratore1 & 6\\
	& & Amministratore2 & 4\\

        \hline
        \textbf{PDC6} & \textbf{Progettazione di Dettaglio} \\
		\cline{3-4}
		PDC6.1 & Progettazione requisiti fondamentali e desiderabili & Progettista1 & 7\\ 
		& & Progettista2 & 7\\
        \cline{3-4}
	PDC6.2 & Verifica requisiti fondamentali e desiderabili & \\
        \cline{3-4}
	PDC6.3 & Progettazione requisiti opzionali & Progettista1 & 4\\
		& & Progettista2 & 4\\
        \cline{3-4}
	PDC6.4 & Verifica requisiti opzionali & Verificatore & 6\\

        \hline
        \textbf{PDC7} & \textbf{Definizione di Prodotto} \\
	\cline{3-4}
	PDC7.1 & Stesura & Progettista & 5\\ 
        & & Verificatore & 3 \\
        \cline{3-4}
        PDC7.2 & Verifica & Progettista & 9\\

        \hline
        \textbf{PDC8} & \textbf{Codifica} \\
	\cline{3-4}
	PDC8.1 & Codifica requisiti fondamentali e desiderabili & Programmatore & 13\\
	& & Programmatore & 13 \\
	& & Programmatore & 22 \\
        \cline{3-4}
	PDC8.2 & Codifica requisiti opzionali & Programmatore & 18\\
		& & Programmatore & 9\\
		& & Programmatore & 7\\
		& & Programmatore & 5\\
        \cline{3-4}
        PDC8.3 & Verificatore & 16\\
...
\begin{table}[H]
	...
	\multicolumn{1}{c}{\textbf{Ore}} \\
        ...
        \hline
	\textbf{PDC9} & \textbf{Manuale Utente} \\
	\cline{3-4}
	PDC9.1 & Stesura & Amministratore & 0\\
        \cline{3-4}
	PDC9.2 & Verifica & Verificatore & 7\\
        \hline
	\end{tabular*}
...
Con l'adozione del modello incrementale il risultato \`e un ultimo momento molto breve in cui eseguire i test di sistema e rilasciare il prodotto completo per il collaudo dell'RA. Nello stesso momento vengono redatti le ultime versioni dei documenti da rilasciare alla commissione e al committente.
