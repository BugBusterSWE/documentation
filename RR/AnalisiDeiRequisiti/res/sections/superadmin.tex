...
\subsection{UC-S1}
    ...
    \begin{center}
      ...
      \begin{longtable}{  p{3.5cm} | p{8cm} } 
        ...
        \textbf{Scenario principale} & 1. Il Super-Admin inserisce il nome della \glossaryItem{Company}.
        
        2. Il Super-Admin inserisce la propria email.
        
        3. Il Super-Admin inserisce una password \\ 
...
\subsection{UC-S0.1.4}
    ...
    \begin{center}
      ...
      \begin{longtable}{  p{3.5cm} | p{8cm} } 
        ...
        \textbf{Attori Primari} & \glossaryItem{Super-Admin}\\  
        \textbf{Scopo e descrizione} & Il \glossaryItem{Super-Admin} entra nella pagina di eliminazione dell'utente, nella quale ha la possibilit\`a
        di eliminarlo. \\
        ...
        \textbf{Postcondizioni} & Il sistema ha seguito le indicazioni dell'\glossaryItem{Attore}. \\ 
         \textbf{Scenario principale} & 1. Il \glossaryItem{Super-Admin} ha la possibilit\`a di confermare l'eliminazione; 
         
         2. Il \glossaryItem{Super-Admin} ha la possibilit\`a ritirare la richiesta di eliminazione. \\
