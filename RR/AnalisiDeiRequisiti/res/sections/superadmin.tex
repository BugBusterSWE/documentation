...
\subsection{UC-S0}
    ...
    \begin{center}
      ...
      \begin{longtable}{  p{3.5cm} | p{8cm} } 
        ...
        2. Il Super-Admin può visualizzare il dettaglio di una \glossaryItem{Company}. (UC-S2)
        
        3. Il Super-Admin pu\`o modificare i dati di una \glossaryItem{Company}. (UC-S3)  \\ 
