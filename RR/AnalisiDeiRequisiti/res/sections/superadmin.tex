...
\subsection{UC-S 0}
    ...
    \begin{center}
      ...
      \begin{longtable}{  p{3.5cm} | p{8cm} } 
        ...
        \textbf{Scenari alternativi} & 1. fallisce l'inserimento di una nuova \textit{Company} \newline 2. fallisce la modifica dei dati di una \textit{Company} \\
      \end{longtable}
      \egroup
    \end{center}
