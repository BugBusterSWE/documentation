...
\subsubsection{UC-E2.0.5}
    ...
    \begin{center}
      ...
      \begin{longtable}{  p{3.5cm} | p{8cm} } 
        ...
        \textbf{Attori Primari} & Utente Autenticato, Ospite, Membro, Admin, Proprietario \\ 
        \textbf{Scopo e Descrizione} & L'intento \`e quello di dare la possibilit\`a all'utilizzatore dell'editor di poter agganciare un Function Element a qualche suo attributo. Con Function Element si esprime la rappresentazione nell'editor di una funzione nel linguaggio di rappresentazione adottato \\ 
...
\subsubsection{UC-E2.0.6}
    ...
    \begin{center}
      ...
      \begin{longtable}{  p{3.5cm} | p{8cm} } 
        ...
        \textbf{Attori Primari} & Utente Autenticato, Ospite, Membro, Admin, Proprietario \\ 
        \textbf{Scopo e Descrizione} & Si da la possibilit\`a di sbloccare campi opzionali nel DSL assegnandogli dei valori di default \\ 
        
        \textbf{Precondizioni}  & L'utente sta visualizzando l'editor e ha la possibilit\`a di creare campi opzionali con valori di default \\ 
        
        \textbf{Postcondizioni} & L'utente ha creato con successo campi opzionali con valori di default
      \end{longtable}
      \egroup
    \end{center}
\subsubsection{UC-E2.1}
    ...
    \begin{center}
      ...
      \begin{longtable}{  p{3.5cm} | p{8cm} } 
        ...
        \textbf{Attori Primari} & Utente Autenticato, Ospite, Membro, Admin, Proprietario \\ 
        \textbf{Scopo e Descrizione} & Si occupa della sezione della parte della Collection nel DSL. Per Collection Element si intende la rappresentazione nell'editor della Collection del DSL. \\ 
