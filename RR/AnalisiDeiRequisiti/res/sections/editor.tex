...
\subsubsection{UC-E2.7}
    ...
    \begin{center}
      ...
      \begin{longtable}{  p{3.5cm} | p{8cm} } 
        ...
        \hline
        \multicolumn{2}{ | c | }{ \cellcolor[gray]{0.9} \textbf{UC-E2.7 - Manipolazione di un Input Element}} \\ 
        \hline
...
\subsubsection{UC-E2.8}
    ...
    \begin{center}
      ...
      \begin{longtable}{  p{3.5cm} | p{8cm} } 
        ...
        \hline
        \multicolumn{2}{ | c | }{ \cellcolor[gray]{0.9} \textbf{UC-E2.8 - Manipolazione di un Cell Element}} \\ 
        \hline
...
\subsubsection{UC-E2.10}
    ...
    \begin{center}
      ...
      \begin{longtable}{  p{3.5cm} | p{8cm} } 
        ...
        \textbf{Scenario Principale} & 1. L'utente pu\`o associare un Cell Element al Dash\glossaryItem{Row Element}. (UC-E2.10.1)
...
\subsubsection{UC-E2.10.1}
    ...
    \begin{center}
      ...
      \begin{longtable}{  p{3.5cm} | p{8cm} } 
        ...
        \hline
        \multicolumn{2}{ | c | }{ \cellcolor[gray]{0.9} \textbf{UC-E2.10.1 - Associare un Cell Element al Dash\glossaryItem{Row Element}}} \\ 
        \hline
        
        \textbf{Attori Primari} & Utente Autenticato, Ospite, Membro, Admin, Owner \\ 
        \textbf{Scopo e Descrizione} & Il sistema da la possibilit\`a di associare un Cell Element ad un Dash\glossaryItem{Row Element}. \\ 
        
        \textbf{Precondizioni}  & Il Cell Element e il Dash\glossaryItem{Row Element} da associare esistono nella sessione corrente dell'editor. \\ 
