...
5. L'utente ha la possibilit\`a di associare un Function Element al \glossaryItem{DSL Element}. (UC-E2.0.5)
...
\subsubsection{UC-E2.0.5}
    ...
    \begin{center}
      ...
      \begin{longtable}{  p{3.5cm} | p{8cm} } 
        ...
        \textbf{Attori Primari} & Utente Autenticato, Ospite, Membro, Admin, Owner \\ 
        \textbf{Scopo e Descrizione} & L'utente ha la possibilit\`a di associare un Function Element ad un attributo selezionabile di un \glossaryItem{DSL Element}. \\ 
        
        \textbf{Precondizioni}  & L'utente visualizza il Function Element e il \glossaryItem{DSL Element} a cui associarlo. \\ 
        
        \textbf{Postcondizioni} & L'utente ha associato con successo la Function Element ad un attributo del \glossaryItem{DSL Element}.
      \end{longtable}
      \egroup
    \end{center}
...
\subsubsection{UC-E2.1.2}
    ...
    \begin{center}
      ...
      \begin{longtable}{  p{3.5cm} | p{8cm} } 
        ...
        \hline
        \multicolumn{2}{ | c | }{ \cellcolor[gray]{0.9} \textbf{UC-E2.1.2 - Associare un Document Element ad un \glossaryItem{Collection Element}}} \\ 
        \hline
        
        \textbf{Attori Primari} & Utente Autenticato, Ospite, Membro, Admin, Owner \\ 
        \textbf{Scopo e Descrizione} & L'utente ha la possibilit\`a di associare un Document Element all'attributo \glossaryItem{Show} del \glossaryItem{Collection Element}. \\ 
        
        \textbf{Precondizioni}  & Il \glossaryItem{Collection Element} a cui associare il Document Element \`e visualizzato nell'editor.  \\ 
        
        \textbf{Postcondizioni} & Il Document Element \`e stato associato all'attributo \glossaryItem{Show} del \glossaryItem{Collection Element} desiderato.
      \end{longtable}
      \egroup
    \end{center}
    ...
    \begin{center}
      ...
      \begin{longtable}{  p{3.5cm} | p{8cm} } 
        ...
        \textbf{Scopo e Descrizione} & Viene data la possibilit\`a all'utente di creare 
            un Function Element collegabile ad un attributo del \glossaryItem{DSL Element}. \\ 
...
\subsubsection{UC-E2.2.1}
    ...
    \begin{center}
      ...
      \begin{longtable}{  p{3.5cm} | p{8cm} } 
        ...
        \textbf{Attori Primari} & Utente Autenticato, Ospite, Membro, Admin, Owner \\ 
        \textbf{Scopo e Descrizione} & L'utente ha la possibilit\`a di definire all'interno di un Function Element una funzione nella sintassi del \glossaryItem{DSL}. \\ 
...
\subsubsection{UC-E2.6}
    ...
    \begin{center}
      ...
      \begin{longtable}{  p{3.5cm} | p{8cm} } 
        ...
        \hline
        \multicolumn{2}{ | c | }{ \cellcolor[gray]{0.9} \textbf{UC-E2.6 - Manipolazione un Document Element}} \\ 
        \hline
