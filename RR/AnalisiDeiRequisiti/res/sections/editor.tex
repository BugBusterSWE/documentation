...
\subsubsection{UC-E0}
    ...
    \begin{center}
      ...
      \begin{longtable}{  p{3.5cm} | p{8cm} } 
        ...
        \textbf{Scopo e Descrizione} & L'utente visualizza l'interfaccia dell'Editor tramite cui puo\` svolgere operazioni di importazione di \glossaryItem{DSL} esistenti, manipolazione dei \glossaryItem{DSL Element} e salvataggio del \glossaryItem{DSL} corrente
        \\
...
\subsubsection{UC-E2.0.1}   
    ...
    \begin{center}
      ...
      \begin{longtable}{  p{3.5cm} | p{8cm} } 
        ...
        \textbf{Scopo e Descrizione} & L'utente ha la possibiltà di aggiungere un \glossaryItem{DSL Element} e di deciderne il tipo. \\ 
...
\subsubsection{UC-E2.0.3}
    ...
    \begin{center}
      ...
      \begin{longtable}{  p{3.5cm} | p{8cm} } 
        ...
        \textbf{Precondizioni}  & L'utente ha a seleziona un attributo e un \glossaryItem{DSL Dependent Element} da associare. \\ 
...
\subsubsection{UC-E2.0.6}
    ...
    \begin{center}
      ...
      \begin{longtable}{  p{3.5cm} | p{8cm} } 
        ...
        \textbf{Attori Primari} & Utente Autenticato, Ospite, Membro, Admin, Owner \\ 
        \textbf{Scopo e Descrizione} & L'utente decide di poter aver accesso ai campi opzionali di un \glossaryItem{DSL Element} e a renderli modificabili. \\ 
...
\subsubsection{UC-E2.3}
    ...
    \begin{center}
      ...
      \begin{longtable}{  p{3.5cm} | p{8cm} } 
        ...
        \textbf{Postcondizioni} & \`E stato manipolato l'\glossaryItem{Index Element} secondo le opzioni indicatre dall'utente. \\ 
...
\subsubsection{UC-E2.6}
    ...
    \begin{center}
      ...
      \begin{longtable}{  p{3.5cm} | p{8cm} } 
        ...
        \textbf{Attori Primari} & Utente Autenticato, Ospite, Membro, Admin, Owner \\ 
        \textbf{Scopo e Descrizione} & L'editor offre la possibilit\`a di manipulare un \glossaryItem{Document Element} agganciandogli altri elementi \\ 
...
\subsubsection{UC-E2.6.1}
    ...
    \begin{center}
      ...
      \begin{longtable}{  p{3.5cm} | p{8cm} } 
        ...
        \textbf{Attori Primari} & Utente Autenticato, Ospite, Membro, Admin, Owner \\ 
        \textbf{Scopo e Descrizione} & Si da la possibilit\`a di aggiungere una \glossaryItem{associazione per riferimento} tra il \glossaryItem{Column Element} e l'attributo populate del \glossaryItem{Document Element}. \\ 
...
\subsubsection{UC-E2.6.2}
    ...
    \begin{center}
      ...
      \begin{longtable}{  p{3.5cm} | p{8cm} } 
        ...
        \textbf{Postcondizioni} & \`E stata manipolata (aggiunta o rimossa) un attributo \glossaryItem{Row} all'interno del \glossaryItem{Document Element}.
      \end{longtable}
      \egroup
    \end{center}
...
\subsubsection{UC-E2.6.4}
    ...
    \begin{center}
      ...
      \begin{longtable}{  p{3.5cm} | p{8cm} } 
        ...
        \textbf{Attori Primari} & Utente Autenticato, Ospite, Membro, Admin, Owner \\ 
        \textbf{Scopo e Descrizione} & Il sistema dispone la funzionalit\`a di associare un Action Element ad un attributo \glossaryItem{Row} di un \glossaryItem{Document Element}. \\ 
        ...
        \textbf{Postcondizioni} & Viene creata un'associazione tra Action Element e l'attributo \glossaryItem{Row} del \glossaryItem{Document Element} indicato dall'utente. 
      \end{longtable}
      \egroup
    \end{center}
...
\subsubsection{UC-E2.7.1}
    ...
    \begin{center}
      ...
      \begin{longtable}{  p{3.5cm} | p{8cm} } 
        ...
        \textbf{Precondizioni}  & L'utente si deve riferire a un \glossaryItem{Input Element} presente nella sessione corrente dell'editor. \\ 
...
\subsubsection{UC-E2.9}
    ...
    \begin{center}
      ...
      \begin{longtable}{  p{3.5cm} | p{8cm} } 
        ...
        \hline
        \multicolumn{2}{ | c | }{ \cellcolor[gray]{0.9} \textbf{UC-E2.9 - Manipolazione di un Dashboard Element}} \\ 
        \hline
        ...
        \textbf{Scenario Principale} & 1. L'utente pu\`o associare un Dash\glossaryItem{Row Element} ad un Dashboard Element. (UC-E2.9.1)
2. L'utente pu\`o aggiungere/rimuovere un attributo \glossaryItem{Row} dal Dashboard Element. (UC-E2.9.2)
      \end{longtable}
      \egroup
    \end{center}
...
\subsubsection{UC-E2.9.1}
    ...
    \begin{center}
      ...
      \begin{longtable}{  p{3.5cm} | p{8cm} } 
        ...
        \hline
        \multicolumn{2}{ | c | }{ \cellcolor[gray]{0.9} \textbf{UC-E2.9.1 - Associare un Dash\glossaryItem{Row Element} ad un Dashboard Element}} \\ 
        \hline
        
        \textbf{Attori Primari} & Utente Autenticato, Ospite, Membro, Admin, Owner \\ 
        \textbf{Scopo e Descrizione} & Permette di definire la struttura di una \glossaryItem{Row} e di legarla a una Dashboard. \\ 
        
        \textbf{Precondizioni}  & il Dashboard Element e il Dash\glossaryItem{Row Element} da collegare esistono nella sessione corrente dell'editor. \\ 
        
        \textbf{Postcondizioni} & Il sistema ha memorizzato il collegamento tra l'attributo \glossaryItem{Row} del Dashboard Element e il Dash\glossaryItem{Row Element}.
      \end{longtable}
      \egroup
    \end{center}
\subsubsection{UC-E2.9.2}
    ...
    \begin{center}
      ...
      \begin{longtable}{  p{3.5cm} | p{8cm} } 
        ...
        \hline
        \multicolumn{2}{ | c | }{ \cellcolor[gray]{0.9} \textbf{UC-E2.9.2 - Aggiungere/Rimuovere un attributo \glossaryItem{Row} dal Dashboard Element}} \\ 
        \hline
        
        \textbf{Attori Primari} & Utente Autenticato, Ospite, Membro, Admin, Owner \\ 
        \textbf{Scopo e Descrizione} & L'utente pu\`o definire una nuovo attributo \glossaryItem{Row} all'interno della Dashboard \\ 
        
        \textbf{Precondizioni}  & Il Dashboard Element esiste nella sessione corrente dell'editor. \\ 
        
        \textbf{Postcondizioni} & Il sistema ha aggiunto o rimosso l'attributo \glossaryItem{Row} dalla Dashboard Element. 
      \end{longtable}
      \egroup
    \end{center}
...
\subsubsection{UC-E2.10}
    ...
    \begin{figure}[H]
      ...
      \caption{UC-E2.10 - Dash\glossaryItem{Row Element}}
      \end{center} 
    \end{figure}
    ...
    \begin{center}
      ...
      \begin{longtable}{  p{3.5cm} | p{8cm} } 
        ...
        \hline
        \multicolumn{2}{ | c | }{ \cellcolor[gray]{0.9} \textbf{UC-E2.10 - Manipolazione di un Dash\glossaryItem{Row Element}}} \\ 
        \hline
        
        \textbf{Attori Primari} & Utente Autenticato, Ospite, Membro, Admin, Owner \\ 
        \textbf{Scopo e Descrizione} & Il sistema fornisce i metodi necessari alla manipolazione di un Dash\glossaryItem{Row Element}. \\ 
        
        \textbf{Precondizioni}  & Il Dash\glossaryItem{Row Element} da manipolare esiste nella sessione corrente dell'editor. \\ 
        
        \textbf{Postcondizioni} & Il sistema ha memorizzato la configurazione del Dash\glossaryItem{Row Element}. \\ 
        \textbf{Scenario Principale} & 1. L'utente pu\`o associare un \glossaryItem{Cell Element} al Dash\glossaryItem{Row Element}. (UC-E2.10.1)
2. L'utente pu\`o associare un \glossaryItem{Document Element} al Dash\glossaryItem{Row Element}. (UC-E2.10.2)
3. L'utente pu\`o associare un \glossaryItem{Collection Element} al Dash\glossaryItem{Row Element}. (UC-E2.10.3)
      \end{longtable}
      \egroup
    \end{center}
\subsubsection{UC-E2.10.1}
    ...
    \begin{center}
      ...
      \begin{longtable}{  p{3.5cm} | p{8cm} } 
        ...
        \hline
        \multicolumn{2}{ | c | }{ \cellcolor[gray]{0.9} \textbf{UC-E2.10.1 - Associare un \glossaryItem{Cell Element} al Dash\glossaryItem{Row Element}}} \\ 
        \hline
        
        \textbf{Attori Primari} & Utente Autenticato, Ospite, Membro, Admin, Owner \\ 
        \textbf{Scopo e Descrizione} & Il sistema da la possibilit\`a di associare un \glossaryItem{Cell Element} ad un Dash\glossaryItem{Row Element}. \\ 
        
        \textbf{Precondizioni}  & Il \glossaryItem{Cell Element} e il Dash\glossaryItem{Row Element} da associare esistono nella sessione corrente dell'editor. \\ 
...
\subsubsection{UC-E2.10.2}
    ...
    \begin{center}
      ...
      \begin{longtable}{  p{3.5cm} | p{8cm} } 
        ...
        \hline
        \multicolumn{2}{ | c | }{ \cellcolor[gray]{0.9} \textbf{UC-E2.10.2 - Associare un \glossaryItem{Document Element} al Dash\glossaryItem{Row Element}}} \\ 
        \hline
        
        \textbf{Attori Primari} & Utente Autenticato, Ospite, Membro, Admin, Owner \\ 
        \textbf{Scopo e Descrizione} & Il sistema da la possibilit\`a di associare un \glossaryItem{Document Element} ad un Dash\glossaryItem{Row Element}. \\ 
        
        \textbf{Precondizioni}  & Il \glossaryItem{Document Element} e il Dash\glossaryItem{Row Element} esistono nella sessione corrente dell'editor. \\ 
...
\subsubsection{UC-E2.10.3}
    ...
    \begin{center}
      ...
      \begin{longtable}{  p{3.5cm} | p{8cm} } 
        ...
        \hline
        \multicolumn{2}{ | c | }{ \cellcolor[gray]{0.9} \textbf{UC-E2.10.3 - Associare un \glossaryItem{Collection Element} ad un Dash\glossaryItem{Row Element}}} \\ 
        \hline
        
        \textbf{Attori Primari} & Utente Autenticato, Ospite, Membro, Admin, Owner \\ 
        \textbf{Scopo e Descrizione} & Il sistema da la possibilit\`a di associare un \glossaryItem{Collection Element} ad un Dash\glossaryItem{Row Element}. \\ 
        
        \textbf{Precondizioni}  & Il \glossaryItem{Collection Element} e il Dash\glossaryItem{Row Element} esistono nella sessione corrente dell'editor. \\ 
...
\subsubsection{UC-E3.1}
    ...
    \begin{center}
      ...
      \begin{longtable}{  p{3.5cm} | p{8cm} } 
        ...
        \textbf{Attori Primari} & Utente Autenticato, Ospite, Membro, Admin, Owner \\ 
        \textbf{Scopo e Descrizione} & L'utente chiede all'applicazione di eseguire le operazioni necessarie affinch\`e il \glossaryItem{DSL} venga salvato ed eseguito con successo. \\ 
...
\subsubsection{UC-E3.3}
    ...
    \begin{center}
      ...
      \begin{longtable}{  p{3.5cm} | p{8cm} } 
        ...
        \textbf{Postcondizioni} & Il \glossaryItem{DSL} \`e stato correttamente memorizzato al sistema \\ 
      \end{longtable}
      \egroup
    \end{center}
