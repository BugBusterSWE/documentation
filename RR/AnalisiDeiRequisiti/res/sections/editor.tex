...
\subsubsection{UC-E2.1.1}
    ...
    \begin{center}
      ...
      \begin{longtable}{  p{3.5cm} | p{8cm} } 
        ...
        \textbf{Attori Primari} & Utente Autenticato, Ospite, Membro, Admin, Owner \\ 
        \textbf{Scopo e Descrizione} & L'utente ha la possibilit\`a di associare un \glossaryItem{Index Element} all'attributo `index` del \glossaryItem{Collection Element} \\ 
...
\subsubsection{UC-E2.3.1}
    ...
    \begin{center}
      ...
      \begin{longtable}{  p{3.5cm} | p{8cm} } 
        ...
        \textbf{Attori Primari} & Utente Autenticato, Ospite, Membro, Admin, Owner \\ 
        \textbf{Scopo e Descrizione} & L'utente ha la possibilit\`a di rimuovere o aggiungere dall'\glossaryItem{Index Element} un attributo Column. \\ 
        
        \textbf{Precondizioni}  &  L'utente \`e all'interno dell'editor e sta visualizzando un \glossaryItem{Index Element} da modificare. \\ 
        
        \textbf{Postcondizioni} & Il sistema aggiunge un attributo Column all'\glossaryItem{Index Element} modificato.
      \end{longtable}
      \egroup
    \end{center}
\subsubsection{UC-E2.3.2}
    ...
    \begin{center}
      ...
      \begin{longtable}{  p{3.5cm} | p{8cm} } 
        ...
        \hline
        \multicolumn{2}{ | c | }{ \cellcolor[gray]{0.9} \textbf{UC-E2.3.2 - Associare un \textit{Column Element} ad un \glossaryItem{Index Element}}} \\ 
        \hline
        
        \textbf{Attori Primari} & Utente Autenticato, Ospite, Membro, Admin, Owner \\ 
        \textbf{Scopo e Descrizione} & L'utente ha la possibilit\`a di associare un Column Element ad un attributo Column di un \glossaryItem{Index Element}. \\ 
        
        \textbf{Precondizioni}  & L'utente visualizza un \glossaryItem{Index Element} su cui associare il Column Element. \\ 
        
        \textbf{Postcondizioni} & Il sistema associa correttamente il Column Element all' \glossaryItem{Index Element} indicato dall'utente.
      \end{longtable}
      \egroup
    \end{center}
...
\subsubsection{UC-E2.6.1}
    ...
    \begin{center}
      ...
      \begin{longtable}{  p{3.5cm} | p{8cm} } 
        ...
        \textbf{Attori Primari} & Utente Autenticato, Ospite, Membro, Admin, Owner \\ 
        \textbf{Scopo e Descrizione} & Si da la possibilit\`a di aggiungere una \glossaryItem{associazione per riferimento} tra il Column Element e l'attributo populate del \glossaryItem{Document Element}. \\ 
        
        \textbf{Precondizioni}  & Il \glossaryItem{Document Element} esiste nella sessione corrente dell'editor \\ 
        
        \textbf{Postcondizioni} & Il sistema aggiunge un riferimento tra il Column Element e il \glossaryItem{Document Element}.
      \end{longtable}
      \egroup
    \end{center}
...
\subsubsection{UC-E2.6.2}
    ...
    \begin{center}
      ...
      \begin{longtable}{  p{3.5cm} | p{8cm} } 
        ...
        \textbf{Attori Primari} & Utente Autenticato, Ospite, Membro, Admin, Owner \\ 
        \textbf{Scopo e Descrizione} & Il sistema dispone la possibilit\`a di aggiungere o rimuovere un attributo Row da un \glossaryItem{Document Element}. \\ 
        
        \textbf{Precondizioni}  & Il \glossaryItem{Document Element} su cui operare l'aggiunta/rimozione di un attributo Row esiste nella sessione corrente dell'editor. \\ 
        
        \textbf{Postcondizioni} & \`E stata manipolata (aggiunta o rimossa) un attributo Row all'interno del \glossaryItem{Document Element}.
      \end{longtable}
      \egroup
    \end{center}
\subsubsection{UC-E2.6.3}
    ...
    \begin{center}
      ...
      \begin{longtable}{  p{3.5cm} | p{8cm} } 
        ...
        \textbf{Attori Primari} & Utente Autenticato, Ospite, Membro, Admin, Owner \\ 
        \textbf{Scopo e Descrizione} & Il sistema dispone la funzionalit\`a di aggiungere un'associazione tra un Row Element e un attributo Row di uno specifico \glossaryItem{Document Element}.  \\ 
        
        \textbf{Precondizioni}  & Il \glossaryItem{Document Element} e il Row Element decisi dall'utente esistono nella sessione corrente dell'editor. \\ 
        
        \textbf{Postcondizioni} & Il sistema ha creato l'associazione tra il Row Element e l'attributo Row del \glossaryItem{Document Element} scelto.
      \end{longtable}
      \egroup
    \end{center}
\subsubsection{UC-E2.6.4}
    ...
    \begin{center}
      ...
      \begin{longtable}{  p{3.5cm} | p{8cm} } 
        ...
        \textbf{Attori Primari} & Utente Autenticato, Ospite, Membro, Admin, Owner \\ 
        \textbf{Scopo e Descrizione} & Il sistema dispone la funzionalit\`a di associare un Action Element ad un attributo Row di un \glossaryItem{Document Element}. \\ 
        
        \textbf{Precondizioni}  & Il \glossaryItem{Document Element} con il relativo attributo Row esistono nella sessione corrente. \\ 
        
        \textbf{Postcondizioni} & Viene creata un'associazione tra Action Element e l'attributo Row del \glossaryItem{Document Element} indicato dall'utente. 
      \end{longtable}
      \egroup
    \end{center}
...
\subsubsection{UC-E2.10}
    ...
    \begin{center}
      ...
      \begin{longtable}{  p{3.5cm} | p{8cm} } 
        ...
        \hline
        \multicolumn{2}{ | c | }{ \cellcolor[gray]{0.9} \textbf{UC-E2.10 - Manipolazione di un DashRow Element}} \\ 
        \hline
...
2. L'utente pu\`o associare un \glossaryItem{Document Element} al DashRow Element. (UC-E2.10.2)
3. L'utente pu\`o associare un \glossaryItem{Collection Element} al DashRow Element. (UC-E2.10.3)
      \end{longtable}
      \egroup
    \end{center}
...
\subsubsection{UC-E2.10.2}
    ...
    \begin{center}
      ...
      \begin{longtable}{  p{3.5cm} | p{8cm} } 
        ...
        \hline
        \multicolumn{2}{ | c | }{ \cellcolor[gray]{0.9} \textbf{UC-E2.10.2 - Associare un \glossaryItem{Document Element} al DashRow Element}} \\ 
        \hline
        
        \textbf{Attori Primari} & Utente Autenticato, Ospite, Membro, Admin, Owner \\ 
        \textbf{Scopo e Descrizione} & Il sistema da la possibilit\`a di associare un \glossaryItem{Document Element} ad un DashRow Element. \\ 
        
        \textbf{Precondizioni}  & Il \glossaryItem{Document Element} e il DashRow Element esistono nella sessione corrente dell'editor. \\ 
...
\subsubsection{UC-E2.10.3}
    ...
    \begin{center}
      ...
      \begin{longtable}{  p{3.5cm} | p{8cm} } 
        ...
        \hline
        \multicolumn{2}{ | c | }{ \cellcolor[gray]{0.9} \textbf{UC-E2.10.3 - Associare un \glossaryItem{Collection Element} ad un DashRow Element}} \\ 
        \hline
        
        \textbf{Attori Primari} & Utente Autenticato, Ospite, Membro, Admin, Owner \\ 
        \textbf{Scopo e Descrizione} & Il sistema da la possibilit\`a di associare un \glossaryItem{Collection Element} ad un DashRow Element. \\ 
        
        \textbf{Precondizioni}  & Il \glossaryItem{Collection Element} e il DashRow Element esistono nella sessione corrente dell'editor. \\ 
