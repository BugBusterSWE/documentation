...
\subsubsection{UC-U13.5}
                ...
                \begin{figure}[H]
                  \begin{center}
                    \includegraphics[width=12cm]{res/img/UCUtenti/UCUtenteA/UC-U13.5-Rimozione utente/UC-U13.5-Rimozione utente}
                  \caption{UC-U13.5 - Rimozione utente}
                  \end{center} 
                \end{figure}
                ...
                \begin{center}
                  ...
                  \begin{longtable}{  p{3.5cm} | p{8cm} } 
                    ...
                    \textbf{Flusso Principale} & 1. Inserimento indirizzo email utente (UC-U13.5.1)\\
                    \textbf{Estensioni} & Nessuna \\
                    \textbf{Inclusioni} & Nessuna
                  \end{longtable}
                  \egroup
                \end{center}
\subsubsection{UC-U13.5.1}
        ...
        \begin{center}
          ...
          \begin{longtable}{  p{3.5cm} | p{8cm} } 
            ...
            \hline
            \multicolumn{2}{ | c | }{ \cellcolor[gray]{0.9} \textbf{UC-U13.5.1 - Inserimento indirizzo email dell'utente da rimuovere}} \\ 
            \hline
            
            \textbf{Attori Primari} & Proprietario \\ 
            \textbf{Scopo e Descrizione} & Inserimento indirizzo email dell'utente da rimuovere.\\ 
