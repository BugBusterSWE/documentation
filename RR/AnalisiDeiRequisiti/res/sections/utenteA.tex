...
\subsubsection{UC-U9.4}
    ...
    \begin{center}
      ...
      \begin{longtable}{  p{3.5cm} | p{8cm} } 
        ...
        \hline
        \multicolumn{2}{ | c | }{ \cellcolor[gray]{0.9} \textbf{UC-U9.4 - Rimozione \textit{Company}}} \\ 
        \hline
        
        \textbf{Attori Primari} & \textit{Owner} \\ 
        \textbf{Scopo e Descrizione} & L'\textit{Owner} decide di rimuovere la \textit{Company} con tutte le sue informazioni e i suoi utenti. \\ 
        
        \textbf{Precondizioni}  & L'\textit{Owner} ha acconsentito alla continuazione della procedura. \\ 
        
        \textbf{Postcondizioni} & L'attore visualizza un messaggio di avvenuta cancellazione e tutti i dati e gli utenti registrati della \textit{Company} vengono cancellati dal sistema. \\ 
      \end{longtable}
      \egroup
    \end{center}
...
\subsubsection{UC-U11.2}
                ...
                \begin{center}
                  ...
                  \begin{longtable}{  p{3.5cm} | p{8cm} } 
                    ...
                    \textbf{Precondizioni}  & L’applicazione è funzionante e pronta all'uso. Gli utenti possono accedere alla propria Dashboard. \\ 
...
2. L'utente autenticato effettua delle operazioni su un elemento della \textit{Dashboard} (UC-U16)

3. L'utente autenticato rimuove degli elementi dalla \textit{Dashboard} (UC-U15.2) \\
      \end{longtable}
      \egroup
    \end{center}
...
\subsubsection{UC-U15.1}
    ...
    \begin{center}
      ...
      \begin{longtable}{  p{3.5cm} | p{8cm} } 
        ...
        \textbf{Attori Primari} & Utente autenticato \\ 
        \textbf{Scopo e Descrizione} & L'utente autenticato visualizza la Dashboard. \\ 
        
        \textbf{Precondizioni}  & L'applicazione mostra la \textit{Dashboard}. \\ 
        
        \textbf{Postcondizioni} & L'utente ha visualizzato la propria \textit{Dashboard}. \\ 
      \end{longtable}
      \egroup
    \end{center}
...
\subsubsection{UC-U15.2}
    ...
    \begin{center}
      ...
      \begin{longtable}{  p{3.5cm} | p{8cm} } 
        ...
        \textbf{Attori Primari} & Utente autenticato \\ 
        \textbf{Scopo e Descrizione} & L'utente autenticato intende eliminare degli elementi presenti nella sua Dashboard. \\ 
        
        \textbf{Precondizioni}  & L'utente si trova nella pagina Dashboard e seleziona l'elemento che vuole eliminare. \\ 
...
\subsubsection{UC-U16}
    ...
    \begin{figure}[H]
      ...
      \caption{UC-U16 - Operazioni sugli elementi della Dashboard}
      \end{center} 
    \end{figure}
    ...
    \begin{center}
      ...
      \begin{longtable}{  p{3.5cm} | p{8cm} } 
        ...
        \hline
        \multicolumn{2}{ | c | }{ \cellcolor[gray]{0.9} \textbf{UC-U16 - Operazioni sugli elementi della \textit{Dashboard}}} \\ 
        \hline
        
        \textbf{Attori Primari} & Utente autenticato \\ 
        \textbf{Scopo e Descrizione} & L'utente autenticato può eseguire le seguenti azioni sugli elementi della \textit{Dashboard}: visualizzare un elemento (che può essere una Cell, un Document o una Collection) oppure effettuare un'operazione su di esso. \\ 
        
        \textbf{Precondizioni}  & L'utente autenticato ha visualizzato la pagina iniziale Dashboard. \\ 
        
        \textbf{Postcondizioni} & L'applicazione ha eseguito le operazioni sulle righe della Dashboard richieste dall'utente autenticato. \\ 
...
\subsubsection{UC-U16.1}
    ...
    \begin{center}
      ...
      \begin{longtable}{  p{3.5cm} | p{8cm} } 
        ...
        \textbf{Attori Primari} & Utente autenticato \\ 
        \textbf{Scopo e Descrizione} & L'utente autenticato sceglie di visualizzare un element dalla Dashboard (che può essere una Cell, un Document o una Collection). \\ 
...
\subsubsection{UC-U16.2}
    ...
    \begin{center}
      ...
      \begin{longtable}{  p{3.5cm} | p{8cm} } 
        ...
        \textbf{Attori Primari} & Utente autenticato \\ 
        \textbf{Scopo e Descrizione} & L'utente autenticato può visualizzare una Cell selezionata nella Dashboard. \\ 
...
\subsubsection{UC-U16.3}
    ...
    \begin{center}
      ...
      \begin{longtable}{  p{3.5cm} | p{8cm} } 
        ...
        \textbf{Attori Primari} & Utente autenticato \\ 
        \textbf{Scopo e Descrizione} & L'utente autenticato può visualizzare un Document selezionato nella Dashboard. \\ 
...
\subsubsection{UC-U16.4}
    ...
    \begin{center}
      ...
      \begin{longtable}{  p{3.5cm} | p{8cm} } 
        ...
        \textbf{Attori Primari} & Utente autenticato \\ 
        \textbf{Scopo e Descrizione} & L'utente autenticato può visualizzare una Collection selezionato nella Dashboard. \\ 
...
\subsubsection{UC-U16.5}
    ...
    \begin{figure}[H]
      \begin{center}
        \includegraphics[width=12cm]{res/img/UCUtenti/UCUtenteA/UC-U16.5-Operazioni_su_Cell/UC-U16.5.png}
    ...
    \begin{center}
      ...
      \begin{longtable}{  p{3.5cm} | p{8cm} } 
        ...
        \textbf{Attori Primari} & Utente autenticato \\ 
        \textbf{Scopo e Descrizione} & L'utente autenticato può eseguire le seguenti operazioni dalla pagina Cell: può aggiungere un valore arbitrario, può modificarne uno, può ordinare il valore nella Cell in base all'unico campo della query (scritta in un momento precedente nell'editor) che ha prodotto tale valore. \\ 
...
\subsubsection{UC-U16.6.4}
    ...
    \begin{center}
      ...
      \begin{longtable}{  p{3.5cm} | p{8cm} } 
        ...
        \hline
        \multicolumn{2}{ | c | }{ \cellcolor[gray]{0.9} \textbf{UC-U16.6.4 - Export di un Document}} \\ 
        \hline
        ...
        \textbf{Precondizioni}  & L'utente autenticato ha visualizzato la pagina del Document su cui effettuare le operazioni di `Export' o di `Send email'. \\ 
...
\subsubsection{UC-U16.6.5}
    ...
    \begin{center}
      ...
      \begin{longtable}{  p{3.5cm} | p{8cm} } 
        ...
        \hline
        \multicolumn{2}{ | c | }{ \cellcolor[gray]{0.9} \textbf{UC-U16.6.5 - Send Mail da un Document}} \\ 
        \hline
        
        \textbf{Attori Primari} & Utente autenticato \\ 
        \textbf{Scopo e Descrizione} & L'utente autenticato può inviare una mail contentenente il Document a un altro utente. \\ 
        
        \textbf{Precondizioni}  & L'utente autenticato ha visualizzato la pagina Document su cui effettuare l'operazione di `Send mail`. \\ 
        
        \textbf{Postcondizioni} & L'applicazione ha inviato la mail con il Document al destinatario segnalato dall'utente. \\ 
      \end{longtable}
      \egroup
    \end{center}
...
5. L'utente autenticato può eseguire l'azione di `export` su un singolo Document. (UC-U16.6.4) \\
...
\subsubsection{UC-U16.7.1}
    ...
    \begin{center}
      ...
      \begin{longtable}{  p{3.5cm} | p{8cm} } 
        ...
        \hline
        \multicolumn{2}{ | c | }{ \cellcolor[gray]{0.9} \textbf{UC-U16.7.1 - Ordina Document}} \\ 
        \hline
        
        \textbf{Attori Primari} & Utente autenticato \\ 
        \textbf{Scopo e Descrizione} & L'utente autenticato può decidere di ordinare i Document della Collection in base a uno dei loro attributi. \\ 
        
        \textbf{Precondizioni}  & L'utente autenticato ha visualizzato la pagina Collection. \\ 
        
        \textbf{Postcondizioni} & L'applicazione ha ordinato i Document secondo l'ordine indicato dall'utente. \\ 
      \end{longtable}
      \egroup
    \end{center}
...
\subsubsection{UC-U16.7.3}
    ...
    \begin{center}
      ...
      \begin{longtable}{  p{3.5cm} | p{8cm} } 
        ...
        \hline
        \multicolumn{2}{ | c | }{ \cellcolor[gray]{0.9} \textbf{UC-U16.7.3 - Send mail da una Collection}} \\ 
        \hline
        
        \textbf{Attori Primari} & Utente autenticato \\ 
        \textbf{Scopo e Descrizione} & L'utente autenticato può inviare una mail contenente i Documents selezionati a un altro utente. \\ 
...
\subsubsection{UC-U16.7.4}
    ...
    \begin{center}
      ...
      \begin{longtable}{  p{3.5cm} | p{8cm} } 
        ...
        \hline
        \multicolumn{2}{ | c | }{ \cellcolor[gray]{0.9} \textbf{UC-U16.7.4 - Export di una Collection}} \\ 
        \hline
        
        \textbf{Attori Primari} & Utente autenticato \\ 
        \textbf{Scopo e Descrizione} & L'utente autenticato può esportare i Documents selezionati da una Collection in formato json o csv. \\ 
