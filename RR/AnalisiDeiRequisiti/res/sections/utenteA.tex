...
\subsubsection{UC-U16.6.5}
    ...
    \begin{center}
      ...
      \begin{longtable}{  p{3.5cm} | p{8cm} } 
        ...
        \textbf{Postcondizioni} & L'applicazione ha inviato la mail. \\ 
      \end{longtable}
      \egroup
    \end{center}
...
\subsubsection{UC-U16.7.3}
    ...
    \begin{center}
      ...
      \begin{longtable}{  p{3.5cm} | p{8cm} } 
        ...
        \hline
        \multicolumn{2}{ | c | }{ \cellcolor[gray]{0.9} \textbf{UC-U16.7.3 - Azione di default - Send mail}} \\ 
        \hline
...
\subsubsection{UC-U16.7.4}
    ...
    \begin{center}
      ...
      \begin{longtable}{  p{3.5cm} | p{8cm} } 
        ...
        \hline
        \multicolumn{2}{ | c | }{ \cellcolor[gray]{0.9} \textbf{UC-U16.7.4 - Export}} \\ 
        \hline
...
\subsubsection{UC-U16.7.5}
    ...
    \begin{center}
      ...
      \begin{longtable}{  p{3.5cm} | p{8cm} } 
        ...
        \hline
        \multicolumn{2}{ | c | }{ \cellcolor[gray]{0.9} \textbf{UC-U16.7.5 - Azione export su un sottoinsieme di Documents}} \\ 
        \hline
        
        \textbf{Attori Primari} & Utente autenticato \\ 
        \textbf{Scopo e Descrizione} & L'utente autenticato ha visualizzato la pagina \textit{Collection} 
        e intende esportarla. \\ 
