...
\subsubsection{UC-U2}   
    ...
    \begin{center}
      ...
      \begin{longtable}{  p{3.5cm} | p{8cm} } 
        ...
        \textbf{Attori Primari} & Utente non autenticato \\ 
        \textbf{Scopo e Descrizione} & L'utente non autenticato visualizza un messaggio d'errore dovuto all'inserimento di dati di una \textit{Company} già registrata. \\ 
