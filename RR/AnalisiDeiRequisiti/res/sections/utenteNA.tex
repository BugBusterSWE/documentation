...
\subsubsection{UC-U0}
    ...
    \begin{center}
      ...
      \begin{longtable}{  p{3.5cm} | p{8cm} } 
        ...
        \textbf{Scenario principale} & 1. L'utente non autenticato crea un account per la propria azienda e si registra a MaaS come proprietario (UC-U1)
...
Il sistema presenta all'utente la pagina di registrazione per un'azienda. \\ 
        ...
        \textbf{Scenario principale} & 1. L'utente non autenticato inserisce il nome della propria azienda (UC-U1.1)
...
\subsubsection{UC-U1.3}
    ...
    \begin{center}
      ...
      \begin{longtable}{  p{3.5cm} | p{8cm} } 
        ...
        \textbf{Scenario principale} & 1. L'utente non autenticato inserisce una password associata all'account dell'azienda. \\
      \end{longtable}
      \egroup
    \end{center}
