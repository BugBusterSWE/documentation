...
\subsubsection{UC-U0}
    ...
    \begin{center}
      ...
      \begin{longtable}{  p{3.5cm} | p{8cm} } 
        ...
        \textbf{Scenario principale} & 1. L'utente non autenticato crea un account per la propria \textit{Company} e si registra a MaaS come proprietario (UC-U1)
...
\subsubsection{UC-U1}
    ...
    \begin{center}
      ...
      \begin{longtable}{  p{3.5cm} | p{8cm} } 
        ...
        \textbf{Attori Primari} & Utente non autenticato \\ 
        \textbf{Scopo e Descrizione} & L'utente non autenticato può creare un account per la propria \textit{Company}, inserendo i seguenti dati: nome della \textit{Company}, indirizzo email del proprietario e una password. \\ 
...
Il sistema presenta all'utente la pagina di registrazione per una \textit{Company}. \\ 
        ...
        \textbf{Postcondizioni} & Una \textit{Company} è stata registrata presso MaaS e l'utente non autenticato ne è divenuto il proprietario. \\ 
