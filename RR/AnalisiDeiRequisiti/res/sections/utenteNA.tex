...
\subsubsection{UC-U2}   
    ...
    \begin{center}
      ...
      \begin{longtable}{  p{3.5cm} | p{8cm} } 
        ...
        \textbf{Scenario principale} & 1. L'utente visualizza il messaggio di errore (UC-U2) \\
      \end{longtable}
      \egroup
    \end{center} 
...
\subsubsection{UC-U5}   
    ...
    \begin{center}
      ...
      \begin{longtable}{  p{3.5cm} | p{8cm} } 
        ...
        \textbf{Postcondizioni} & L'utente ha visualizzato il messaggio di errore. \\ 
        \textbf{Scenario principale} & 1. L'utente visualizza il messaggio di errore (UC-U5) \\
      \end{longtable}
      \egroup
    \end{center}    
